...
import { Box, Checkbox, Pagination, Table, TableBody, Typography } from 'ui/atoms';
...
export const TableList: <T>(p: TableListProps<T>) => React.ReactElement<TableListProps<T>> = ({
  items,
  itemIndex,
  header: TableHead,
  renderItem,
