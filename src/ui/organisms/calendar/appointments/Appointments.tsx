...
import { AppointmentContainerProps, AppointmentNodeProps as AppointmentProp, ViewProps } from './Appointment.types';
import { useStyles } from './Appointments.styles';

const AppointmentComponent = ({ view, ...props }: App.AppointmentProps & ViewProps) => {
