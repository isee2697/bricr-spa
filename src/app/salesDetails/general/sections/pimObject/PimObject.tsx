...
import { LinkPimObjectModalContainer } from 'app/email/linkPimObjectModal/LinkPimObjectModalContainer';

import { PimObjectProps } from './PimObject.types';
import { PimItem } from './PimItem';

export const PimObject = ({ pims, onLinkPims }: PimObjectProps) => {
        ...
        <CardHeader
          ...
          action={
            <Box display="flex" alignItems="center">
              ...
              />
              <Box ml={3} />
              <IconButton size="small" variant="circle" color="primary" onClick={() => open('link-pim-object')}>
                <AddIcon />
              </IconButton>
              <Box ml={3} />
