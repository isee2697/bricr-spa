...
export const Agenda = () => {
  ...
  const agendaData = [
    ...
    },
    {
      ...
      startDate: new Date().toISOString(),
      endDate: laterToday.toISOString(),
      title: 'My Third Today appointment, which cant be moved',
    },
    {
      isAllDay: false,
  ...
  return (
    <Card className={classes.root}>
      <Tabs
        ...
        variant="fullWidth"
      >
        <Tab label={formatMessage({ id: 'sales_details.dashboard.agenda.appointments' })} />
        <Tab label={formatMessage({ id: 'sales_details.dashboard.agenda.action_required' })} />
      </Tabs>
      <CardContent>
