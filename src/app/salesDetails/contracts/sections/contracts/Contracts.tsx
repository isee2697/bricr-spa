...
export const Contracts = () => {
  ...
  return (
    <Card>
      <CardHeader
        title={formatMessage({ id: 'sales_details.contracts.contracts' })}
        action={
      ...
      <CardContent>
        <InfoSection emoji="🤔" color="gradient">
          <Typography variant="h3">
            {formatMessage({
              id: 'sales_details.contracts.contracts.linked_contracts.empty_title',
            })}
          </Typography>
          <Typography variant="h3">
            {formatMessage({
              id: 'sales_details.contracts.contracts.linked_contracts.empty_description',
            })}
          </Typography>
          <Box mt={2}>
            <Button
              ...
              size="small"
            >
              {formatMessage({ id: 'sales_details.contracts.contracts.linked_contracts.link_contract' })}
            </Button>
          </Box>
        </InfoSection>
      </CardContent>
