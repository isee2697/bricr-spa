...
import { useStyles } from './AllocateResultsDetailItem.styles';
import { AllocateResultsDetailItemProps } from './AllocateResultsDetailItem.types';
...
export const AllocateResultsDetailItem = ({ isSidebarVisible, onSidebarOpen }: AllocateResultsDetailItemProps) => {
  ...
  const handleNavigateToResults = () => {
    push(joinUrlParams(`${AppRoute.projectDetails}/allocateResults/:resultId`, params));
  };
