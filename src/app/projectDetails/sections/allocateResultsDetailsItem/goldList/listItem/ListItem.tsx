          ...
          <Box width="100%" ml={5}>
            <Grid container spacing={1}>
              <Grid item xs={4}>
                ...
                <Box mt={1.5}>
                  <Typography variant="h6" className={classes.gray}>
                    {formatMessage({ id: 'project_details.allocate_results_details.date_of_subscription' })}
                  </Typography>
                  <Typography variant="h4">
              ...
              <Grid item xs={4}>
                ...
                <Box mt={1.5}>
                  <Typography variant="h6" className={classes.gray}>
                    {formatMessage({ id: 'project_details.allocate_results_details.maximum_mortgage' })}
                  </Typography>
