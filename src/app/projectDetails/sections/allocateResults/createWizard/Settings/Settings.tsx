        ...
        <CardContent>
          <Box display="flex" justifyContent="space-between" alignItems="center" flexWrap="wrap">
            <Typography variant="h2">
              {formatMessage({ id: 'project_details.allocate_results.settings.title' })}
            </Typography>
            <FormControlLabel
              control={
                <Switch
              ...
              label={formatMessage({ id: 'project_details.allocate_results.settings.use_sales_settings' })}
              ...
              <Grid item xs={12}>
                <Box className={classes.marginTopSix}>
                  <Typography variant="h3">
                    {formatMessage({
                      id: 'project_details.allocate_results.settings.name',
                    })}
                  </Typography>
                  <Box>
                    <GenericField
                      name="allocationName"
                      label={formatMessage({ id: 'project_details.allocate_results.settings.name_of_allocation' })}
                ...
                <Box className={classes.marginTopFour}>
                  <Box display="flex" justifyContent="space-between">
                    <Typography variant="h3">
                      {formatMessage({
                        id: 'project_details.allocate_results.settings.candidates_assigned_per_property',
                      })}
                    </Typography>
                    <Typography variant="h5" className={classes.gray}>
                      {formatMessage({
                        id: 'project_details.allocate_results.settings.provide_candidates_amount',
                      })}
                    </Typography>
                  </Box>
                  <Box>
                ...
                <Box className={classes.marginTopFour}>
                  <Typography variant="h3">
                    {formatMessage({
                      id: 'project_details.allocate_results.settings.price_conditions',
                    })}
                  </Typography>
                  <Grid container>
                ...
                <Box className={classes.marginTopFour}>
                  <Typography variant="h3">
                    {formatMessage({
                      id: 'project_details.allocate_results.settings.rental_price_calculation',
                    })}
                  </Typography>
                  <Box display="flex" alignItems="flex-end">
                    <GenericField
                      ...
                      label={formatMessage(
                        { id: 'project_details.allocate_results.settings.joint_month_income' },
                        {
                          option: (
                    ...
                    <GenericField
                      ...
                      label={formatMessage(
                        { id: 'project_details.allocate_results.settings.monthly_rent_by_joint_income' },
                        {
                          option: (
                            <Typography variant="h6" className={classes.bold}>
                              {formatMessage({ id: 'common.min' })}
                    ...
                    <GenericField
                      name="factorMin"
                      label={formatMessage({ id: 'project_details.allocate_results.settings.factor' })}
                      placeholder={formatMessage({
                  ...
                  <Grid container>
                    <Grid item xs={4}>
                      <GenericField
                        ...
                        label={formatMessage(
                          { id: 'project_details.allocate_results.settings.joint_annual_income' },
                          {
                            option: (
                              <Typography variant="h6" className={classes.bold}>
                                {formatMessage({ id: 'common.min' })}
                        ...
                        placeholder={formatMessage({
                          id: 'project_details.allocate_results.settings.joint_annual_income.placeholder',
                        })}
                        InputProps={{ endAdornment: <EuroIcon /> }}
                ...
                <Box className={classes.marginTopFour}>
                  <Typography variant="h3">
                    {formatMessage({
                      id: 'project_details.allocate_results.settings.maximum_mortgage_calculation',
                    })}
                  </Typography>
                  <Grid container spacing={4}>
                    ...
                    <Grid item xs={5}>
                      <GenericField
                        ...
                        label={formatMessage({ id: 'project_details.allocate_results.settings.marge' })}
                        placeholder={formatMessage({
                ...
                <Box className={classes.marginTopFour}>
                  <Typography variant="h3">
                    {formatMessage({
                      id: 'project_details.allocate_results.settings.joint_income_calculation',
                    })}
                  </Typography>
                  <Grid container spacing={4}>
                    <Grid item xs={5}>
                      <GenericField
                        ...
                        label={formatMessage({
                          id: 'project_details.allocate_results.settings.lowest_income_percentage',
                        })}
                        placeholder={formatMessage({
                    ...
                    <Grid item xs={5}>
                      <GenericField
                        ...
                        label={formatMessage({
                          id: 'project_details.allocate_results.settings.include_pension_income',
                        })}
                        placeholder={formatMessage({
                ...
                <Box className={classes.marginTopFour}>
                  <Typography variant="h3">
                    {formatMessage({
                      id: 'project_details.allocate_results.settings.first_person_from_couple',
                    })}
                  </Typography>
                  <Grid container spacing={4}>
                    <Grid item xs={5}>
                      <GenericField
                        ...
                        label={formatMessage({
                          id: 'project_details.allocate_results.settings.available_capital_count',
                        })}
                        placeholder={formatMessage({
                    ...
                    <Grid item xs={5}>
                      <GenericField
                        ...
                        label={formatMessage({
                          id: 'project_details.allocate_results.settings.deduct_monthly_obligations',
                        })}
                        placeholder={formatMessage({
                ...
                <Box className={classes.marginTopFour}>
                  <Typography variant="h3">
                    {formatMessage({
                      id: 'project_details.allocate_results.settings.second_person_from_couple',
                    })}
                  </Typography>
                  <Grid container spacing={4}>
                    <Grid item xs={5}>
                ...
                <Box className={classes.marginTopFour}>
                  <Typography variant="h3">
                    {formatMessage({
                      id:
                        'project_details.allocate_results.settings.calculate_joint_income_with_distribution_threshold',
                    })}
                  </Typography>
                  <Grid container spacing={4}>
                    <Grid item xs={5}>
                      <GenericField
                        ...
                        label={formatMessage(
                          {
                            id: 'project_details.allocate_results.settings.different_lowest_highest_income',
                          },
                          {
                            option: (
                              <Typography variant="h6" className={classes.bold}>
                    ...
                    <Grid item xs={5}>
                      <GenericField
                        ...
                        label={formatMessage(
                          {
                            id: 'project_details.allocate_results.settings.fictitious_income_with_highest_income',
                          },
                          {
                            option: (
                              <Typography variant="h6" className={classes.bold}>
