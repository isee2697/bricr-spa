...
export const Documents = () => {
  ...
  return (
    <Card>
      <CardHeader
        title={formatMessage({ id: 'project_details.allocate_results.documents.title' })}
        action={
          <>
            <FormControlLabel
          ...
          <Grid item xs={12}>
            <Box>
              <Typography variant="h3">
                {formatMessage({
                  id: 'project_details.allocate_results.filtering_people.accepted_number_of_missing_documents',
                })}
              </Typography>
            ...
            <Box className={classes.marginTopFour}>
              <CheckboxField
                ...
                label={formatMessage({
                  id: 'project_details.allocate_results.filtering_people.only_accepted_documents',
                })}
              />
            </Box>
          </Grid>
