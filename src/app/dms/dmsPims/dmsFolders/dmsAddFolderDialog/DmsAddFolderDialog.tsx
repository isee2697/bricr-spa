...
import { DmsAddFolderDialogProps } from './DmsAddFolderDialog.types';

export const DmsAddFolderDialog = ({ isOpened, onClose, onSubmit, isAdd, folderName }: DmsAddFolderDialogProps) => {
