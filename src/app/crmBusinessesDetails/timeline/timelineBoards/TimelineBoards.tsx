...
import { useStyles } from './timelineBoards.styles';
import { BusinessTimelineBoardsProps } from './TimelineBoards.types';

export const BusinessTimelineBoards = ({ timelineItems }: BusinessTimelineBoardsProps) => {
