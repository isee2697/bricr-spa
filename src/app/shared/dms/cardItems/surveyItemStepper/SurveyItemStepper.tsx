...
import { SurveyStepperProps } from './SurveyItemStepper.types';
import { useStyles } from './SurveyItemStepper.styles';
...
export const SurveyItemStepper = ({ steps }: SurveyStepperProps) => {
