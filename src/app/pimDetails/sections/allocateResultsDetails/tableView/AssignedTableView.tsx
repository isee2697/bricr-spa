...
export const AssignedTableView = ({
  ...
  const sortOptions: SortOption[] = [
    {
      name: formatMessage({ id: 'pim.details.allocateResults.sort_option.newest' }),
      key: 'newest',
    },
  ];
  ...
  const headerCells: AssignedTableHeaderCell[] = [
    {
      field: 'name',
      label: formatMessage({ id: 'pim.details.allocateResults.assigned.document_name' }),
    },
    {
      field: 'date',
      label: formatMessage({ id: 'pim.details.allocateResults.assigned.date' }),
      renderer: property => (
    ...
    {
      field: 'type',
      label: formatMessage({ id: 'pim.details.allocateResults.assigned.type' }),
    },
    {
      field: 'price',
      label: formatMessage({ id: 'pim.details.allocateResults.assigned.price' }),
