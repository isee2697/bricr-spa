...
export const Couples = () => {
  ...
  return (
    <Card>
      <CardHeader
        title={formatMessage({ id: 'pim_details.allocate_results.couples.title' })}
        action={
          <>
            <FormControlLabel
          ...
          <Grid item xs={12}>
            <Box>
              <CheckboxField
                ...
                label={formatMessage({
                  id: 'pim_details.allocate_results.filtering_people.determine_which_of_a_couple_you_use_to_assign',
                })}
              />
            </Box>
            <Box className={classes.marginTopFour}>
              <Box display="flex" justifyContent="space-between">
                <Typography variant="h3">
                  {formatMessage({
                    id: 'pim_details.allocate_results.filtering_people.sort_criteria_order',
                  })}
                </Typography>
                <Typography variant="h5" className={classes.gray}>
                  {formatMessage({
                    id: 'pim_details.allocate_results.filtering_people.drag_drop_in_preferred_order',
                  })}
                </Typography>
              </Box>
              <Box mt={2}>
