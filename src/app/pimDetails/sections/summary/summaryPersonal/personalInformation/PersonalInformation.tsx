...
export const PersonalInformation = () => {
  ...
  const profiles: Profile[] = [
    {
      id: 'U-0001',
      firstName: 'Victor Martin',
      lastName: 'Brochner',
      email: 'martin@cubiceyes.com',
      phoneNumbers: [
        {
          id: 'T-0001',
  ...
  return (
    <Card className={classes.root}>
      <CardHeader title={formatMessage({ id: 'pim_details.summary.personal.personal_information.title' })} />
      <CardContent>
        <Grid container spacing={1}>
          {profiles.map((profile, index) => (
            <PersonalInformationItem className={classes.personalInfoItem} profile={profile} />
          ))}
          <Box className={classes.marginTopThree}>
            <Typography variant="h5" className={classes.detailItemLabel}>
              {formatMessage({ id: 'pim_details.summary.personal.personal_information.reason_selling' })}
            </Typography>
            <Typography variant="h4" className={classes.detailItemValue}>
              Morbi posuere orci rhoncus mollis pretium. Suspendisse diam lacus, viverra et tellu..
            </Typography>
          </Box>
          <Box className={classes.detailItem}>
            <Typography variant="h5" className={classes.detailItemLabel}>
              {formatMessage({ id: 'pim_details.summary.personal.personal_information.internal_comment' })}
            </Typography>
            <Typography variant="h4" className={classes.detailItemValue}>
              Morbi posuere orci rhoncus mollis pretium. Suspendisse diam lacus, viverra et tellus quis, volutpat
              pharetra risus. Nulla ullamcorper erat a nisi consequat auctor.
            </Typography>
          </Box>
          <Box className={classes.detailItem}>
            <Typography variant="h5" className={classes.detailItemLabel}>
              {formatMessage({ id: 'pim_details.summary.personal.personal_information.divorced' })}
            </Typography>
            <Typography variant="h4" className={classes.detailItemValue}>
              No
            </Typography>
