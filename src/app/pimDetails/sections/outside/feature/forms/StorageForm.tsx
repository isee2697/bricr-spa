      ...
      <Box mb={4}>
        ...
        <Box paddingLeft={2} mb={1}>
          <CheckboxGroupField
            ...
            options={dictionaries.storageTypes}
            disabled={!inEditMode}
          />
        </Box>
        <Box mb={2}>
        ...
        <CheckboxField label="pim_details.outside.is_attached" name="configuration.attached" disabled={!inEditMode} />
      </Box>
      ...
      <Box mb={4}>
        ...
        <Box pl={2}>
          <CheckboxGroupField
            ...
            options={dictionaries.storageInsulations}
          />
        </Box>
        <Box mt={3}>
          <CheckboxField
      ...
      <Box mb={4}>
        ...
        <Box paddingLeft={2} mb={1}>
          <CheckboxGroupField
            ...
            options={dictionaries.storageServices}
            disabled={!inEditMode}
          />
        </Box>
      </Box>
      ...
      <Box mb={3}>
        <FormSubSectionHeader
          ...
          subtitle={formatMessage(
            ...
            { name: formatMessage({ id: 'dictionaries.outside_type.Storage' }).toLowerCase() },
          )}
        />
