...
export function SecurityDetailsForm() {
  ...
  return (
    <FormSection title={formatMessage({ id: 'crm.details.documents.document_details' })} isExpandable isInitExpanded>
      {editing => (
        <AutosaveForm onSave={() => Promise.resolve(undefined)}>
          <FormSubSectionHeader
            title={formatMessage({ id: 'crm.details.documents.visible_for_role' })}
