...
export function SecurityRightsForm() {
  ...
  return (
    <FormSection title={formatMessage({ id: 'crm.details.documents.document_rights' })} isExpandable isInitExpanded>
      {editing => (
        <AutosaveForm onSave={() => Promise.resolve(undefined)}>
          <FormSubSectionHeader
            title={formatMessage({ id: 'crm.details.documents.type_of_document' })}
