...
export const InvoiceItem = ({
  ...
  return (
    <Box display="flex" width="100%" className={classes.invoiceItem}>
      <Box mr={2}>
        <Avatar variant="rounded" size="medium" src={avatar} className={classes.invoiceImage}>
          {!avatar && <Emoji>{'📷'}</Emoji>}
        </Avatar>
      </Box>
      <Box width="100%">
        <Typography variant="h5" className={classes.invoiceTitle}>
          {address}
        </Typography>
        <Box display="flex" mt={2}>
          <Box mr={3.5}>
            <Typography variant="h6" className={classes.invoiceLabel}>
              {formatMessage({
                id: 'crm.details.sales.dashboard.invoices.info_completed',
              })}
            </Typography>
          ...
          <Box>
            <Typography variant="h6" className={classes.invoiceLabel}>
              {formatMessage({
                id: 'crm.details.sales.dashboard.invoices.documents',
              })}
            </Typography>
...
export const InvoicesBoard = () => {
  ...
  return (
    <Card>
      <CardHeader title={formatMessage({ id: 'crm.details.sales.dashboard.invoices' })} />
      <CardContent>
