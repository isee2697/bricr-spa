...
import { AgendaItem, Badge, Button, Card, CardActions, CardContent, IconButton, Scrollable, Tab, Tabs } from 'ui/atoms';
import { AddIcon } from 'ui/atoms/icons';
import { useLocale } from 'hooks';
import { AgendaItemProps } from 'ui/atoms/agendaItem/AgendaItem.types';

import { useStyles } from './ActionsAndAcquisition.styles';

export const ActionsAndAcquisition = () => {
  ...
  return (
    <Card className={classes.root}>
      <Tabs
        ...
        variant="fullWidth"
      >
        <Tab label={formatMessage({ id: 'crm.details.sales.dashboard.actions_and_acquisition.recent_actions' })} />
        <Tab
          label={
            <Badge badgeContent={3} color="error" classes={{ badge: classes.acquisitionBadge }}>
              {formatMessage({ id: 'crm.details.sales.dashboard.actions_and_acquisition.acquisition' })}
            </Badge>
          }
        />
      </Tabs>
