...
export const CrmRelationsDetailsCustomerJourneyYourNewHome = () => {
  ...
  return (
    <>
      <NavBreadcrumb
        title={formatMessage({ id: 'crm.details.customer_journey.your_new_home.title' })}
        to="/customer_journey/your_new_home"
                          ...
                          <Box>
                            ...
                            <Box display="flex">
                              <Typography variant="h6" className={clsx(classes.property, classes.fontWeightMedium)}>
                                {formatMessage({ id: 'crm.details.customer_journey.room_size' }, { size: home.size })}
                              </Typography>
                              <Typography variant="h6" className={clsx(classes.property, classes.fontWeightMedium)}>
                                {formatMessage({ id: 'crm.details.customer_journey.rooms' }, { rooms: home.rooms })}
                              </Typography>
                    ...
                    <Grid container spacing={1}>
                      ...
                      <Grid item xs={3}>
                        ...
                        <Typography variant="h4" className={classes.bold}>
                          {formatMessage({ id: `crm.details.customer_journey.your_new_home.${home.status}` })}
                        </Typography>
                      </Grid>
                    </Grid>
                  </Box>
