...
import { useStyles } from './NotaryItem.styles';
import { NotaryItemProps } from './NotaryItem.types';

export const NotaryItem = ({ partner: { firstName, lastName, email, avatar } }: NotaryItemProps) => {
        ...
        <Box display="flex" className={classes.details}>
          <Box width="50%">
            <Typography variant="h6" className={classes.fontWeightBold}>
              {formatMessage({ id: 'crm.details.professional_contacts_notary.office' })}
            </Typography>
          ...
          <Box width="50%">
            <Typography variant="h6" className={classes.fontWeightBold}>
              {formatMessage({ id: 'crm.details.professional_contacts_notary.contact' })}
            </Typography>
          </Box>
        </Box>
      </Box>
