...
export type AddMatchProfileMutation = (
  ...
  & { addMatchProfile?: Maybe<(
    { __typename?: 'MatchProfile' }
    & Pick<MatchProfile, 'id' | 'crmId' | 'companyId' | 'propertyType' | 'startDate' | 'endDate' | 'matchWith' | 'description' | 'estateType' | 'commercialEstateType' | 'conditions' | 'services' | 'tags'>
    & { matchDuration?: Maybe<(
      { __typename?: 'MatchProfileDateRange' }
...
export const DeleteMatchProfileDocument = gql`
    mutation DeleteMatchProfile($id: ID!) @rest(type: "DeleteMatchProfileResponse", path: "/delete-match?id={args.id}", method: "DELETE", endpoint: "default") {
