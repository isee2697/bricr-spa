...
export type UpdateCrmGeneralMutation = (
  ...
  & { updateCrmGeneral?: Maybe<(
    { __typename?: 'CrmGeneral' }
    & Pick<CrmGeneral, 'id' | 'firstName' | 'extraNames' | 'insertion' | 'lastName' | 'gender' | 'dateOfBirth' | 'placeOfBirth' | 'nationality' | 'preferredLanguage' | 'identification' | 'identificationNumber' | 'identificationIssueCity' | 'identificationIssueDate' | 'preferredTitlePrefix' | 'preferredTitleSuffix' | 'preferredLetterSalutation' | 'preferredTitleInformation' | 'status'>
...
export type GetCrmFamilyContactsQuery = (
  ...
  & { getCrmFamilyContacts?: Maybe<(
    ...
    & { partner?: Maybe<(
      { __typename?: 'LinkedCrm' }
      & Pick<LinkedCrm, 'id' | 'firstName' | 'insertion' | 'lastName' | 'email'>
      & { avatar?: Maybe<(
        { __typename?: 'File' }
        & Pick<File, 'url'>
      )> }
...
export type CrmListQuery = (
  ...
  & { crmList?: Maybe<Array<(
    { __typename?: 'CrmListItem' }
    & Pick<CrmListItem, 'id' | 'type' | 'firstName' | 'insertion' | 'lastName' | 'phoneNumber' | 'email' | 'status'>
    & { avatar?: Maybe<(
      { __typename?: 'File' }
      & Pick<File, 'url'>
    )> }
...
export type AdvancedSearchQuery = (
  ...
  & { advancedSearch?: Maybe<(
    ...
    & { users?: Maybe<Array<(
      ...
      { __typename?: 'CrmListItem' }
      & Pick<CrmListItem, 'id' | 'type' | 'firstName' | 'insertion' | 'lastName' | 'phoneNumber' | 'email'>
      & { avatar?: Maybe<(
        { __typename?: 'File' }
        & Pick<File, 'url'>
      )> }
