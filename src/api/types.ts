...
export type GetQuestionaireQuery = (
  ...
  & { getQuestionaire?: Maybe<(
    { __typename?: 'Questionaire' }
    & Pick<Questionaire, 'id' | 'templateName' | 'isAdmin' | 'published' | 'copyFromId' | 'isActive'>
    & { entity?: Maybe<(
      { __typename?: 'Entity' }
      & Pick<Entity, 'type' | 'subType'>
    )> }
...
export type GetQuestionairesQuery = (
  ...
  & { getQuestionaires?: Maybe<Array<(
    { __typename?: 'Questionaire' }
    & Pick<Questionaire, 'id' | 'templateName' | 'isAdmin' | 'isActive' | 'published' | 'copyFromId' | 'type'>
    & { meta: (
      { __typename?: 'TemplateMeta' }
...
export const GetQuestionaireDocument = gql`
  ...
  getQuestionaire(id: $id) @rest(type: "Questionaire", path: "/template/{args.id}", method: "POST", endpoint: "default") {
    id
    templateName
    isAdmin
    published
