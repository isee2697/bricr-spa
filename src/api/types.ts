...
export type CreateQuestionaireMutation = (
  ...
  & { createQuestionaire?: Maybe<(
    { __typename?: 'Questionaire' }
    & Pick<Questionaire, 'id' | 'questionaireName' | 'isAdmin' | 'published' | 'copyFromId'>
    & { entity?: Maybe<(
      { __typename?: 'Entity' }
...
export const CreateQuestionaireDocument = gql`
  ...
  createQuestionaire(input: $input) @rest(type: "Questionaire", path: "/questionaire", method: "POST", endpoint: "default") {
    id
    questionaireName
    isAdmin
    published
...
export const GetQuestionaireDocument = gql`
  ...
  getQuestionaire(id: $id) @rest(type: "Questionaire", path: "/questionaire/{args.id}", method: "POST", endpoint: "default") {
    id
    questionaireName
    isAdmin
    published
...
export const GetQuestionairesDocument = gql`
    query GetQuestionaires($search: String, $from: Int, $limit: Int) {
  getQuestionaires(pagination: {from: $from, limit: $limit}, search: $search) @rest(type: "Questionaire", path: "/questionaires", method: "GET", endpoint: "default") {
    id
    questionaireName
    isAdmin
    published
