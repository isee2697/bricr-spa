...
export type DraftAppointmentMutation = (
  { __typename?: 'Mutation' }
  & { draftAppointment: (
    { __typename?: 'DraftAppointment' }
    & Pick<DraftAppointment, 'id' | 'from' | 'to' | 'travelTimeBefore' | 'travelTimeAfter' | 'title' | 'allDay' | 'type' | 'isInsideOffice' | 'location' | 'outsideLocation' | 'taskLabel' | 'state' | 'agreementType' | 'repeatAppointment' | 'description' | 'appointmentType' | 'assignedPimIds' | 'invitedPersons'>
  ) }
);
...
export type ListDmsFoldersQuery = (
  ...
  & { listDmsFolders?: Maybe<Array<(
    { __typename?: 'DmsFolder' }
    & Pick<DmsFolder, 'id' | 'entityId' | 'companyId' | 'foldername' | 'entityType' | 'type' | 'order' | 'deletedAt' | 'isEmailFolder'>
  )>> }
);
...
export const DraftAppointmentDocument = gql`
  ...
  draftAppointment(input: $input) {
    ...
    `;
export function useDraftAppointmentMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<DraftAppointmentMutation, DraftAppointmentMutationVariables>) {
        return ApolloReactHooks.useMutation<DraftAppointmentMutation, DraftAppointmentMutationVariables>(DraftAppointmentDocument, baseOptions);
      }
...
export type DraftAppointmentMutationOptions = ApolloReactCommon.BaseMutationOptions<DraftAppointmentMutation, DraftAppointmentMutationVariables>;
export const ConfirmAppointmentDocument = gql`
  ...
  confirmAppointment(appointmentId: $appointmentId, accountId: $accountId) {
    ...
    `;
export function useConfirmAppointmentMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ConfirmAppointmentMutation, ConfirmAppointmentMutationVariables>) {
        return ApolloReactHooks.useMutation<ConfirmAppointmentMutation, ConfirmAppointmentMutationVariables>(ConfirmAppointmentDocument, baseOptions);
      }
...
export type ConfirmAppointmentMutationOptions = ApolloReactCommon.BaseMutationOptions<ConfirmAppointmentMutation, ConfirmAppointmentMutationVariables>;
...
export const ListDmsFoldersDocument = gql`
  ...
  listDmsFolders(entityId: $entityId) @rest(type: "ListDmsFolders", path: "/dms/folders/list/{args.entityId}", method: "GET", endpoint: "default") {
    id
    entityId
    companyId
    foldername
