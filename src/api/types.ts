...
export type GetQuestionairesQuery = (
  { __typename?: 'Query' }
  & { getQuestionaires?: Maybe<Array<(
    { __typename?: 'Questionaire' }
    & Pick<Questionaire, 'id' | 'templateName' | 'isAdmin' | 'isActive' | 'published' | 'copyFromId' | 'type' | 'labels'>
    & { meta: (
      { __typename?: 'TemplateMeta' }
      & Pick<TemplateMeta, 'createdAt'>
    ), entity?: Maybe<(
...
export const GetQuestionairesDocument = gql`
  ...
  getQuestionaires(pagination: {from: $from, limit: $limit}, search: $search, type: $type) @rest(type: "Questionaire", path: "/templates/{args.type}", method: "GET", endpoint: "default") {
    id
    templateName
    isAdmin
    isActive
