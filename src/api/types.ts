...
export type ListNylasAccountQuery = (
  ...
  & { listNylasAccount?: Maybe<Array<(
    { __typename?: 'NylasAccountItem' }
    & Pick<NylasAccountItem, 'id' | 'email' | 'provider' | 'billingState' | 'syncState'>
  )>> }
);
...
export type PimOverallInfoQuery = (
  ...
  & { getPimGeneral: (
    ...
    { __typename?: 'PimMedia' }
    & Pick<PimMedia, 'id' | 'mainPictureId'>
    & { pictures?: Maybe<Array<(
      { __typename?: 'Picture' }
      & Pick<Picture, 'id'>
      & { file?: Maybe<(
...
export const AuthorizeNylasAccountWithTokenDocument = gql`
    mutation AuthorizeNylasAccountWithToken($nylasToken: String!, $isCalendarConnected: Boolean, $isEmailConnected: Boolean) {
  authorizeNylasAccountWithToken(nylasToken: $nylasToken, isCalendarConnected: $isCalendarConnected, isEmailConnected: $isEmailConnected) {
    id
    userId
    accountId
    accessToken
