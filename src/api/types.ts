...
export const GetTasksDocument = gql`
    query GetTasks($search: String, $assignees: [ID!], $from: Date, $to: Date, $sortColumn: String!, $sortDirection: SortDirection!) {
  getTasks(filters: {search: $search, assignees: $assignees, deadline: {from: $from, to: $to}}, sort: {column: $sortColumn, direction: $sortDirection}) {
    items {
      id
      taskIndex
      title
