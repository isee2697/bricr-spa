...
export type CreateQuestionaireMutation = (
  ...
  & { createQuestionaire?: Maybe<(
    { __typename?: 'Questionaire' }
    & Pick<Questionaire, 'id' | 'templateName' | 'isAdmin' | 'published' | 'copyFromId'>
    & { entity?: Maybe<(
      { __typename?: 'Entity' }
...
export type GetQuestionaireQuery = (
  ...
  & { getQuestionaire?: Maybe<(
    { __typename?: 'Questionaire' }
    & Pick<Questionaire, 'id' | 'templateName' | 'isAdmin' | 'published' | 'copyFromId' | 'isActive' | 'type'>
    & { entity?: Maybe<(
      { __typename?: 'Entity' }
      & Pick<Entity, 'type' | 'subType'>
    )>, settings?: Maybe<(
...
export const GetQuestionairesDocument = gql`
  ...
  getQuestionaires(filters: $filters, pagination: $pagination, search: $search) @rest(type: "GetQuestionaires", path: "/templates/{args.filters.type}?isActive={args.filters.isActive}&page={args.pagination.page}&limit={args.pagination.limit}", method: "GET", endpoint: "default") {
    items {
      id
      templateName
      isAdmin
...
export const GetQuestionairesCountDocument = gql`
  ...
  active: getQuestionaires(filters: $filters, search: $search) @rest(type: "GetQuestionairesCount", path: "/templates/{args.filters.type}?isActive=true&countOnly=true", method: "GET", endpoint: "default") {
    count
  }
  inactive: getQuestionaires(filters: $filters, search: $search) @rest(type: "GetQuestionairesCount", path: "/templates/{args.filters.type}?isActive=false&countOnly=true", method: "GET", endpoint: "default") {
    count
  }
}
    `;
