...
export type AddAllocateMutation = (
  { __typename?: 'Mutation' }
  & { addAllocate?: Maybe<(
    { __typename?: 'Allocate' }
    & Pick<Allocate, 'id'>
...
export type UpdateAllocateMutation = (
  { __typename?: 'Mutation' }
  & { updateAllocate?: Maybe<(
    { __typename?: 'Allocate' }
    & Pick<Allocate, 'id'>
  )> }
);
...
export type DeleteAllocateMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'deleteAllocate'>
);
...
export type VerifyUserMutation = (
  ...
  & { verifyUser?: Maybe<(
    { __typename?: 'VerifyUserResponse' }
    & Pick<VerifyUserResponse, 'status'>
  )> }
);
...
export type AddAppointmentMutation = (
  ...
  & { addAppointment: (
    { __typename?: 'Appointment' }
    & Pick<Appointment, 'id' | 'from' | 'to' | 'travelTimeBefore' | 'travelTimeAfter' | 'title' | 'allDay' | 'type' | 'isInsideOffice' | 'location' | 'outsideLocation' | 'taskLabel' | 'state' | 'agreementType' | 'repeatAppointment' | 'description' | 'appointmentType' | 'assignedPimIds' | 'invitedPersons'>
  ) }
);
...
export type UpdateCrmContactInformationMutation = (
  { __typename?: 'Mutation' }
  & { updateCrmContactInformation?: Maybe<(
    { __typename?: 'CrmContactInformation' }
    & Pick<CrmContactInformation, 'id' | 'contactInfoDescription' | 'dateCreated' | 'dateUpdated'>
    & { addresses?: Maybe<Array<(
      { __typename?: 'CrmAddress' }
      & Pick<CrmAddress, 'type' | 'street' | 'houseNumber' | 'addition' | 'zipcode' | 'city' | 'country' | 'extraInformation' | 'availableFrom' | 'note'>
    )>>, emailAddresses?: Maybe<Array<(
      { __typename?: 'CrmEmailAddress' }
      & Pick<CrmEmailAddress, 'type' | 'email' | 'availableFrom' | 'note'>
    )>>, phoneNumbers?: Maybe<Array<(
      { __typename?: 'CrmPhoneNumber' }
      & Pick<CrmPhoneNumber, 'type' | 'countryCode' | 'phoneNumber' | 'availableFrom' | 'note'>
    )>>, socialMedia?: Maybe<Array<(
      { __typename?: 'CrmSocialMedia' }
      & Pick<CrmSocialMedia, 'type' | 'url'>
    )>>, lastEditedBy?: Maybe<(
      { __typename?: 'LastUpdatedProfile' }
      & Pick<LastUpdatedProfile, 'id' | 'firstName' | 'lastName'>
    )> }
  )> }
);
...
export type UpdateCrmFamilyContactsMutation = (
  { __typename?: 'Mutation' }
  & { updateCrmFamilyContacts?: Maybe<(
    { __typename?: 'CrmFamilyContacts' }
    & Pick<CrmFamilyContacts, 'id' | 'maritalStatus' | 'maritalStatusDate' | 'maritalStatusInformation' | 'familyCompositionChildren' | 'familyCompositionAdults' | 'familyCompositionInformation'>
    & { partners?: Maybe<Array<(
      { __typename?: 'CrmPartner' }
      & Pick<CrmPartner, 'isDivorced'>
      & { partner: (
        { __typename?: 'LinkedCrm' }
        & Pick<LinkedCrm, 'id' | 'firstName' | 'initials' | 'lastName' | 'email' | 'isPassedAway' | 'dateOfDeath'>
        & { avatar?: Maybe<(
          { __typename?: 'File' }
          & Pick<File, 'url'>
        )> }
...
export type UpdateCrmFinancialMutation = (
  { __typename?: 'Mutation' }
  & { updateCrmFinancial?: Maybe<(
    { __typename?: 'CrmFinancial' }
    & Pick<CrmFinancial, 'id'>
  )> }
);
...
export type CreateCrmMutation = (
  { __typename?: 'Mutation' }
  & { createCrm: (
    { __typename?: 'CrmGeneral' }
    & Pick<CrmGeneral, 'id' | 'firstName' | 'initials' | 'lastName' | 'dateCreated' | 'completeness'>
  ) }
);
...
export type UpdateCrmGeneralMutation = (
  { __typename?: 'Mutation' }
  & { updateCrmGeneral?: Maybe<(
    { __typename?: 'CrmGeneral' }
    & Pick<CrmGeneral, 'id' | 'firstName' | 'extraNames' | 'initials' | 'lastName' | 'gender' | 'dateOfBirth' | 'placeOfBirth' | 'nationality' | 'dateOfDeath' | 'isPassedAway' | 'preferredLanguage' | 'identification' | 'identificationNumber' | 'identificationIssueCity' | 'identificationIssueDate' | 'identificationExpirationDate' | 'preferredTitlePrefix' | 'preferredTitleSuffix' | 'preferredLetterSalutation' | 'preferredTitleInformation' | 'status'>
    & { identificationNumbers?: Maybe<Array<(
      { __typename?: 'CrmIdentificationNumber' }
      & Pick<CrmIdentificationNumber, 'type' | 'number' | 'name'>
    )>>, avatar?: Maybe<(
      { __typename?: 'File' }
...
export type UpdateCrmHomeSituationMutation = (
  { __typename?: 'Mutation' }
  & { updateCrmHomeSituation?: Maybe<(
    { __typename?: 'CrmHomeSituation' }
    & Pick<CrmHomeSituation, 'id' | 'currentHomeSituation' | 'currentHomeStatus' | 'currentHomeSalesValue' | 'currentHomeMortgage' | 'currentHomeInformation' | 'reasonToMove' | 'movingDate' | 'movingInformation'>
  )> }
);
...
export type CreateDmsFileMutation = (
  { __typename?: 'Mutation' }
  & { createDmsFile: (
    { __typename?: 'DmsFile' }
    & Pick<DmsFile, 'id' | 'signedUrl'>
  ) }
);
...
export type CreateDmsFolderMutation = (
  { __typename?: 'Mutation' }
  & { createDmsFolder: (
    { __typename?: 'DmsFolder' }
    & Pick<DmsFolder, 'id'>
...
export type UpdateKikSettingsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'updateKikSettings'>
);
...
export type UpdateKikInfoMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'updateKikInfo'>
);
...
export type AddCrmLabelMutation = (
  { __typename?: 'Mutation' }
  & { addCrmLabel: (
    { __typename?: 'Label' }
    & Pick<Label, 'id' | 'property' | 'text' | 'icon'>
...
export type AddMatchProfileMutation = (
  { __typename?: 'Mutation' }
  & { addMatchProfile?: Maybe<(
    { __typename?: 'MatchProfile' }
    & Pick<MatchProfile, 'id' | 'crmId' | 'companyId' | 'propertyType' | 'startDate' | 'endDate' | 'matchWith' | 'description' | 'estateType' | 'commercialEstateType' | 'conditions' | 'services' | 'tags' | 'isActive' | 'createdAt'>
    & { matchDuration?: Maybe<(
      { __typename?: 'MatchProfileDateRange' }
      & Pick<MatchProfileDateRange, 'from' | 'to'>
    )>, characteristics?: Maybe<(
      { __typename?: 'MatchCharacteristics' }
      & Pick<MatchCharacteristics, 'general'>
      & { property?: Maybe<(
        { __typename?: 'MatchCharacteristicsProperty' }
        & Pick<MatchCharacteristicsProperty, 'minAmountRooms' | 'minAmountBedrooms' | 'residentialLayerFrom' | 'residentialLayerTo' | 'constructionYearFrom' | 'constructionYearTo' | 'maintenanceQuality'>
      )> }
    )>, commercialCharacteristics?: Maybe<(
      { __typename?: 'MatchCommercialCharacteristics' }
      & Pick<MatchCommercialCharacteristics, 'general'>
      & { property?: Maybe<(
        { __typename?: 'MatchCommercialCharacteristicsProperty' }
        & Pick<MatchCommercialCharacteristicsProperty, 'minFreeHeight' | 'minFreeSpan' | 'minFloorLoad' | 'minAmountOfFloors' | 'minParkingLots' | 'engergyLabel' | 'constructionYearFrom' | 'constructionYearTo' | 'maintenanceQuality'>
      )> }
    )>, pricing?: Maybe<(
      { __typename?: 'MatchPricing' }
      & Pick<MatchPricing, 'buyFrom' | 'buyTo' | 'rentFrom' | 'rentTo' | 'rentFrequency' | 'rentalPeriod' | 'preferredStartDate'>
    )>, outside?: Maybe<(
      { __typename?: 'MatchOutsidePricing' }
      & Pick<MatchOutsidePricing, 'minGarage'>
    )>, garden?: Maybe<(
      { __typename?: 'MatchGarden' }
      & Pick<MatchGarden, 'situation' | 'outdoorSpacesMin' | 'outdoorSpacesMax' | 'volumeMin' | 'volumeMax'>
    )>, measurements?: Maybe<(
      { __typename?: 'MatchMeasurements' }
      & Pick<MatchMeasurements, 'surfaceFromMin' | 'surfaceToMin' | 'livingAreaFromMin' | 'livingAreaToMin' | 'businessSpaceSurfaceFromMin' | 'businessSpaceSurfaceToMin' | 'practiceRoomSurfaceToMax' | 'practiceRoomSurfaceToMin' | 'plotSurfaceFromMin' | 'plotSurfaceToMin'>
    )>, revenue?: Maybe<(
      { __typename?: 'IntRange' }
      & Pick<IntRange, 'from' | 'to'>
    )>, exploitation?: Maybe<(
      { __typename?: 'IntRange' }
      & Pick<IntRange, 'from' | 'to'>
    )>, requirements?: Maybe<Array<(
      { __typename?: 'MatchRequirement' }
      & Pick<MatchRequirement, 'key' | 'status'>
    )>>, locations?: Maybe<Array<(
      { __typename?: 'MatchProfileLocation' }
      & Pick<MatchProfileLocation, 'latitude' | 'longitude' | 'street' | 'houseNumber' | 'radius'>
    )>> }
  )> }
);
...
export type CloneMatchProfileMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateMatchProfileMutation = (
  { __typename?: 'Mutation' }
...
export type DeleteMatchProfileMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'deleteMatchProfile'>
);
...
export type BulkReadNotificationsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'bulkReadNotifications'>
);
...
export type BulkDeleteNotificationsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'bulkDeleteNotifications'>
);
...
export type AuthorizeNylasAccountMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'authorizeNylasAccount'>
);
...
export type AuthorizeNylasAccountWithTokenMutation = (
  { __typename?: 'Mutation' }
  & { authorizeNylasAccountWithToken?: Maybe<(
    { __typename?: 'NylasAccount' }
    & Pick<NylasAccount, 'id' | 'userId' | 'accountId' | 'accessToken' | 'newAccount' | 'isCalendarConnected' | 'isEmailConnected'>
  )> }
);
...
export type CreatePimMutation = (
  ...
  & { createPim?: Maybe<(
    { __typename?: 'Pim' }
    & Pick<Pim, 'id' | 'realEstateType' | 'street' | 'houseNumber' | 'postalCode' | 'city' | 'developmentType'>
...
export type ConfirmProfileInviteMutation = (
  { __typename?: 'Mutation' }
  & { confirmProfileInvite: (
    { __typename?: 'Profile' }
    & Pick<Profile, 'id'>
  ) }
);
...
export type CreateEmailAddressMutation = (
  { __typename?: 'Mutation' }
  & { createEmailAddress: (
    { __typename?: 'Profile' }
    & Pick<Profile, 'id'>
...
export type CreateSocialMediaLinkMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateSocialMediaLinkMutation = (
  { __typename?: 'Mutation' }
...
export type CreateSalesMutation = (
  ...
  & { createSales?: Maybe<(
    { __typename?: 'Sales' }
    & Pick<Sales, 'id' | 'label' | 'status' | 'createdAt' | 'updatedAt' | 'name' | 'type' | 'extraInfo' | 'attentionNote' | 'date'>
  )> }
);
...
export type AddNewSubtaskMutation = (
  { __typename?: 'Mutation' }
  & { addSubtask: (
    { __typename?: 'Task' }
    & Pick<Task, 'id'>
...
export type UpdateSubtaskStatusMutation = (
  { __typename?: 'Mutation' }
  & { updateSubtaskStatus?: Maybe<(
    { __typename?: 'Task' }
    & Pick<Task, 'id'>
  )> }
);
...
export type UpdateUserInTeamMutation = (
  { __typename?: 'Mutation' }
  & { updateUserInTeam?: Maybe<(
    { __typename?: 'Team' }
    & Pick<Team, 'id'>
  )> }
);
...
export type CreateQuestionaireMutation = (
  { __typename?: 'Mutation' }
  & { createQuestionaire?: Maybe<(
    { __typename?: 'Questionaire' }
    & Pick<Questionaire, 'id' | 'templateName' | 'templateStatus' | 'isAdmin' | 'published' | 'copyFromId'>
    & { entity?: Maybe<(
      { __typename?: 'Entity' }
      & Pick<Entity, 'type' | 'subType'>
    )> }
  )> }
);
...
export type UpdateQuestionaireMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateTemplateGeneralMutation = (
  { __typename?: 'Mutation' }
  & { updateTemplateGeneral?: Maybe<(
    { __typename?: 'Questionaire' }
    & Pick<Questionaire, 'id'>
  )> }
);
...
export type CreateQuestionaireGroupMutation = (
  { __typename?: 'Mutation' }
  & { createQuestionaireGroup?: Maybe<(
    { __typename?: 'Groups' }
    & Pick<Groups, 'id' | 'templateId' | 'groupName' | 'copyFromId' | 'order'>
    & { entity?: Maybe<(
      { __typename?: 'Entity' }
      & Pick<Entity, 'type' | 'subType'>
    )> }
...
export type UpdateQuestionaireGroupMutation = (
  { __typename?: 'Mutation' }
...
export type DeleteQuestionaireGroupMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'deleteQuestionaireGroup'>
);
...
export type CreateQuestionMutation = (
  ...
  & { createQuestion?: Maybe<(
    { __typename?: 'Question' }
    & Pick<Question, 'id' | 'groupId' | 'order' | 'type' | 'name' | 'required' | 'commentEnabled' | 'showOn'>
...
export type TiaraSendMessageMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'tiaraSendMessage'>
);
...
export type UpdateWorkflowTriggerMutation = (
  { __typename?: 'Mutation' }
  & { updateWorkflowTrigger: (
    { __typename?: 'WorkflowTrigger' }
    & Pick<WorkflowTrigger, 'id'>
  ) }
);
...
export type GetAllocateQuery = (
  { __typename?: 'Query' }
  & { getAllocate?: Maybe<(
    { __typename?: 'Allocate' }
    & Pick<Allocate, 'id' | 'companyId' | 'objectId' | 'name' | 'version' | 'note' | 'assignToRole'>
    & { criteria?: Maybe<(
      { __typename?: 'AllocateCriteria' }
      & Pick<AllocateCriteria, 'type' | 'startDate' | 'endDate' | 'amountAssignedCandidates' | 'isPublishedExternally'>
      & { rentalePriceCalculation?: Maybe<(
        { __typename?: 'AllocateRentalPriceCalculation' }
        & Pick<AllocateRentalPriceCalculation, 'minJointIncome' | 'maxJointIncome' | 'minRentByIncome' | 'maxRentByIcome'>
      )>, interestDetails?: Maybe<(
        { __typename?: 'AllocateInterestDetails' }
        & Pick<AllocateInterestDetails, 'minNumberOfPreferences' | 'registrationForm' | 'registrationTo' | 'assignOnlyWithInterest'>
      )>, documents?: Maybe<(
        { __typename?: 'AllocateCriteriaDocuments' }
        & Pick<AllocateCriteriaDocuments, 'acceptedMissingDocumentsNumber' | 'onlyAcceptedDocuments'>
      )>, criteriaOrder?: Maybe<Array<(
        { __typename?: 'AllocateCriteriaOrder' }
        & Pick<AllocateCriteriaOrder, 'name' | 'order' | 'checked'>
      )>> }
    )>, people?: Maybe<(
      { __typename?: 'AllocatePeople' }
      & { jointIncome?: Maybe<(
        { __typename?: 'AllocatePeopleJointIncome' }
        & Pick<AllocatePeopleJointIncome, 'lowestPercentage' | 'distributionThreshold' | 'ficitousCalculation' | 'includePension'>
      )>, income?: Maybe<(
        { __typename?: 'AllocatePeopleIncome' }
        & Pick<AllocatePeopleIncome, 'availableCapitalCount' | 'deductMonthlyObligations' | 'minAge' | 'employementType'>
      )>, partnerIncome?: Maybe<(
        { __typename?: 'AllocatePeopleIncome' }
        & Pick<AllocatePeopleIncome, 'availableCapitalCount' | 'deductMonthlyObligations' | 'minAge' | 'employementType'>
      )> }
      ...
      { __typename?: 'AllocateHome' }
      & Pick<AllocateHome, 'amountChildren' | 'amountAdults' | 'situation' | 'hasCurrentResidence'>
    )> }
  )> }
);
...
export type ListAllocatesQuery = (
  { __typename?: 'Query' }
  & { listAllocates?: Maybe<Array<(
    { __typename?: 'Allocate' }
    & Pick<Allocate, 'id' | 'companyId' | 'objectId' | 'name' | 'version' | 'note' | 'assignToRole'>
    & { criteria?: Maybe<(
      { __typename?: 'AllocateCriteria' }
...
export type CheckCompanyRegisteredQuery = (
  { __typename?: 'Query' }
  & { checkCompanyRegistered: (
    { __typename?: 'CheckRegisteredResponse' }
    & Pick<CheckRegisteredResponse, 'suggestions' | 'taken'>
  ) }
);
...
export type GetCompanyDetailsQuery = (
  ...
  & { getCompanyDetails: (
    { __typename?: 'Company' }
    & Pick<Company, 'id' | 'name' | 'domain' | 'address' | 'addressSecondLine' | 'state' | 'city' | 'zipcode' | 'country' | 'houseNumber' | 'floor' | 'chamberOfCommerce' | 'vat'>
    & { image?: Maybe<(
      { __typename?: 'File' }
      & Pick<File, 'url' | 'id'>
    )> }
...
export type GetCrmContactInformationQuery = (
  { __typename?: 'Query' }
  & { getCrmContactInformation?: Maybe<(
    ...
    & { addresses?: Maybe<Array<(
      { __typename?: 'CrmAddress' }
      & Pick<CrmAddress, 'id' | 'type' | 'street' | 'houseNumber' | 'addition' | 'zipcode' | 'city' | 'country' | 'extraInformation' | 'availableFrom' | 'note'>
    )>>, emailAddresses?: Maybe<Array<(
      { __typename?: 'CrmEmailAddress' }
      & Pick<CrmEmailAddress, 'id' | 'type' | 'email' | 'availableFrom' | 'note'>
    )>>, phoneNumbers?: Maybe<Array<(
      { __typename?: 'CrmPhoneNumber' }
      & Pick<CrmPhoneNumber, 'id' | 'type' | 'countryCode' | 'phoneNumber' | 'availableFrom' | 'note'>
    )>>, socialMedia?: Maybe<Array<(
      { __typename?: 'CrmSocialMedia' }
      & Pick<CrmSocialMedia, 'id' | 'type' | 'url'>
    )>>, lastEditedBy?: Maybe<(
      { __typename?: 'LastUpdatedProfile' }
      & Pick<LastUpdatedProfile, 'id' | 'firstName' | 'lastName'>
    )> }
...
export type GetCrmFamilyContactsQuery = (
  { __typename?: 'Query' }
...
export type GetCrmFinancialQuery = (
  { __typename?: 'Query' }
  & { getCrmFinancial?: Maybe<(
    { __typename?: 'CrmFinancial' }
    & Pick<CrmFinancial, 'id' | 'financialInfo'>
    & { income?: Maybe<Array<(
      { __typename?: 'CrmIncome' }
      & Pick<CrmIncome, 'id' | 'type' | 'information'>
      & { employerIncome?: Maybe<(
        { __typename?: 'CrmEmployerIncome' }
        & Pick<CrmEmployerIncome, 'profession' | 'employmentType' | 'grossIncome' | 'grossIncomePeriod' | 'holidayBonus' | 'fixedThirteenthMonth' | 'irregularityAllowance' | 'irregularityAllowancePeriod' | 'profitDistribution' | 'profitDistributionPeriod' | 'commission' | 'commissionPeriod' | 'overtime' | 'overtimePeriod'>
        & { employer?: Maybe<(
          { __typename?: 'LinkedCrm' }
          & Pick<LinkedCrm, 'id' | 'firstName' | 'extraNames' | 'initials' | 'lastName' | 'email' | 'phoneNumber'>
          & { avatar?: Maybe<(
            { __typename?: 'File' }
            & Pick<File, 'id' | 'url'>
          )> }
          ...
          { __typename?: 'CrmEmployerInformation' }
          & Pick<CrmEmployerInformation, 'name' | 'street' | 'houseNumber' | 'addition' | 'zipcode' | 'city' | 'country'>
        )> }
      )>, equityIncome?: Maybe<(
        { __typename?: 'CrmEquityIncome' }
        & Pick<CrmEquityIncome, 'income'>
      )>, pensionIncome?: Maybe<(
        { __typename?: 'CrmPensionIncome' }
        & Pick<CrmPensionIncome, 'aowBenefit' | 'aowBenefitPeriod' | 'retirementBenefit' | 'retirementBenefitPeriod'>
      )>, socialBenefitIncome?: Maybe<(
        { __typename?: 'CrmSocialBenefitIncome' }
        & Pick<CrmSocialBenefitIncome, 'income' | 'incomePeriod' | 'socialBenefitType'>
      )>, entrepreneurIncome?: Maybe<(
        { __typename?: 'CrmEntrepreneurIncome' }
        & Pick<CrmEntrepreneurIncome, 'entrepreneurType' | 'companyCar' | 'companyBike' | 'pastPensionAge' | 'smeProfitExemption' | 'incomePerYear' | 'workingHoursPerMonth' | 'yearsAsIndependent'>
      )> }
    )>>, financialObligations?: Maybe<Array<(
      { __typename?: 'CrmFinancialObligation' }
      & Pick<CrmFinancialObligation, 'id' | 'type' | 'financialObligation' | 'information'>
    )>>, bankAccounts?: Maybe<Array<(
      { __typename?: 'CrmBankAccount' }
      & Pick<CrmBankAccount, 'id' | 'type' | 'accountNumber' | 'bic' | 'iban' | 'swift' | 'purpose'>
    )>> }
  )> }
);
...
export type GetCrmGeneralQuery = (
  { __typename?: 'Query' }
  & { getCrmGeneral?: Maybe<(
    { __typename?: 'CrmGeneral' }
    & Pick<CrmGeneral, 'id' | 'firstName' | 'extraNames' | 'initials' | 'lastName' | 'gender' | 'dateOfBirth' | 'placeOfBirth' | 'nationality' | 'dateOfDeath' | 'isPassedAway' | 'preferredLanguage' | 'identification' | 'identificationNumber' | 'identificationIssueCity' | 'identificationIssueDate' | 'identificationExpirationDate' | 'preferredTitlePrefix' | 'preferredTitleSuffix' | 'preferredLetterSalutation' | 'preferredTitleInformation' | 'status' | 'completeness' | 'dateCreated' | 'dateUpdated'>
    & { identificationNumbers?: Maybe<Array<(
      { __typename?: 'CrmIdentificationNumber' }
      & Pick<CrmIdentificationNumber, 'type' | 'number' | 'name'>
    )>>, avatar?: Maybe<(
...
export type GetCrmHomeSituationQuery = (
  { __typename?: 'Query' }
...
export type CrmListQuery = (
  ...
  & { crmList: (
    ...
    & { items?: Maybe<Array<(
      { __typename?: 'CrmListItem' }
      & Pick<CrmListItem, 'id' | 'type' | 'firstName' | 'initials' | 'lastName' | 'gender' | 'dateOfBirth' | 'placeOfBirth' | 'nationality' | 'maritalStatus' | 'familyCompositionChildren' | 'familyCompositionAdults' | 'currentHomeSituation' | 'phoneNumber' | 'email' | 'status' | 'dateCreated' | 'dateUpdated' | 'completeness'>
      & { partners?: Maybe<Array<(
        { __typename?: 'CrmPartner' }
        & { partner: (
          { __typename?: 'LinkedCrm' }
          & Pick<LinkedCrm, 'id' | 'firstName' | 'lastName'>
          & { avatar?: Maybe<(
            { __typename?: 'File' }
            & Pick<File, 'url'>
          )> }
...
export type ListCrmsCountQuery = (
  { __typename?: 'Query' }
  & { actionRequired: (
    { __typename?: 'CrmListSearchResult' }
    & { metadata?: Maybe<(
...
export type GetCrmWithSameInfoQuery = (
  { __typename?: 'Query' }
  & { getCrmWithSameInfo: (
    { __typename?: 'CrmListSearchResult' }
    & { metadata?: Maybe<(
...
export type CrmBulkDetailsQuery = (
  { __typename?: 'Query' }
  & { status?: Maybe<Array<(
    { __typename?: 'GetBulkResult' }
...
export type ListDmsFolderFilesQuery = (
  { __typename?: 'Query' }
  & { listDmsFolderFiles?: Maybe<Array<(
    { __typename?: 'DmsFile' }
    & Pick<DmsFile, 'id' | 'folderId' | 'companyId' | 'fileName' | 'isPrivate' | 'signedUrl'>
    & { entity?: Maybe<(
      { __typename?: 'Entity' }
      & Pick<Entity, 'type' | 'subType'>
    )>, meta: (
      { __typename?: 'DmsFileMeta' }
      & Pick<DmsFileMeta, 'createdAt' | 'deletedAt' | 'fileType'>
    ) }
  )>> }
);
...
export type ListDmsFoldersQuery = (
  { __typename?: 'Query' }
  & { listDmsFolders?: Maybe<Array<(
    { __typename?: 'DmsFolder' }
    & Pick<DmsFolder, 'id' | 'entityId' | 'companyId' | 'foldername' | 'entityType' | 'type' | 'order' | 'deletedAt' | 'isEmailFolder' | 'viewType' | 'filesCount'>
  )>> }
);
...
export type ListEmailFoldersQuery = (
  { __typename?: 'Query' }
  & { listEmailFolders?: Maybe<Array<(
    { __typename?: 'EmailFolderListItem' }
    & Pick<EmailFolderListItem, 'numberOfUnreadEmails'>
    & { folder: (
      { __typename?: 'EmailFolder' }
      & Pick<EmailFolder, 'id' | 'name' | 'displayName' | 'nylasFolderId'>
    ) }
  )>> }
);
...
export type ListEmailQuery = (
  { __typename?: 'Query' }
  & { listEmail?: Maybe<Array<(
    { __typename?: 'EmailListItem' }
    & Pick<EmailListItem, 'id' | 'subject' | 'date' | 'thread_id'>
    & { folder: (
      { __typename?: 'EmailFolder' }
      & Pick<EmailFolder, 'id' | 'name' | 'displayName'>
    ), from: Array<(
      { __typename?: 'EmailAndName' }
      & Pick<EmailAndName, 'name' | 'email'>
    )>, to: Array<(
      { __typename?: 'EmailAndName' }
      & Pick<EmailAndName, 'name' | 'email'>
    )> }
...
export type GetEmailQuery = (
  ...
  & { getEmail?: Maybe<(
    { __typename?: 'Email' }
    & Pick<Email, 'id' | 'subject' | 'body' | 'date' | 'thread_id'>
    & { folder: (
      { __typename?: 'EmailFolder' }
      & Pick<EmailFolder, 'id' | 'name' | 'displayName'>
    ), from: Array<(
      ...
      { __typename?: 'EmailAttachment' }
      & Pick<EmailAttachment, 'id' | 'filename'>
    )>>, threads?: Maybe<(
      { __typename?: 'EmailThread' }
      & Pick<EmailThread, 'id' | 'message_ids'>
      & { participants: Array<(
        { __typename?: 'EmailAndName' }
        & Pick<EmailAndName, 'email' | 'name'>
      )> }
    )>, threadMessages?: Maybe<Array<(
      { __typename?: 'ThreadMessage' }
      & Pick<ThreadMessage, 'id' | 'subject' | 'date'>
      & { from: Array<(
        { __typename?: 'EmailAndName' }
        & Pick<EmailAndName, 'name' | 'email'>
      )>, to: Array<(
...
export type GetKikSettingsQuery = (
  { __typename?: 'Query' }
  & { getKikSettings?: Maybe<(
    { __typename?: 'KikSettings' }
    & Pick<KikSettings, 'username'>
  )> }
);
...
export type GetCrmLabelsQuery = (
  { __typename?: 'Query' }
  & { getCrmLabels?: Maybe<Array<(
    { __typename?: 'Label' }
    & Pick<Label, 'id' | 'property' | 'icon' | 'text'>
  )>> }
);
...
export type ListPimsQuery = (
  ...
  & { listPims: (
    ...
    & { items?: Maybe<Array<(
      { __typename?: 'ListPim' }
      & Pick<ListPim, 'id' | 'street' | 'houseNumberPrefix' | 'houseNumber' | 'houseNumberAddition' | 'constructionNumberPrefix' | 'constructionNumber' | 'constructionNumberAddition' | 'city' | 'dateCreated' | 'livingArea' | 'propertyType' | 'postalCode' | 'country' | 'salePrice' | 'rentPrice' | 'completeness' | 'archived' | 'attentionNote'>
...
export type GetMatchProfileQuery = (
  { __typename?: 'Query' }
...
export type ListMatchProfilesQuery = (
  { __typename?: 'Query' }
  & { listMatchProfiles?: Maybe<Array<(
    { __typename?: 'MatchProfile' }
    & Pick<MatchProfile, 'id' | 'crmId' | 'companyId' | 'propertyType' | 'startDate' | 'endDate' | 'matchWith' | 'description' | 'estateType' | 'commercialEstateType' | 'conditions' | 'services' | 'tags' | 'isActive' | 'createdAt'>
    & { matchDuration?: Maybe<(
      { __typename?: 'MatchProfileDateRange' }
...
export type NcpMediaQuery = (
  ...
  & { getNcpMedia: (
    { __typename?: 'NcpMedia' }
    & Pick<NcpMedia, 'id' | 'mediaDescription' | 'dateUpdated'>
    & { lastEditedBy?: Maybe<(
      { __typename?: 'LastUpdatedProfile' }
      & Pick<LastUpdatedProfile, 'id' | 'firstName' | 'lastName'>
    )>, pictures?: Maybe<Array<(
      { __typename?: 'Picture' }
      & Pick<Picture, 'id' | 'name' | 'description' | 'type' | 'dateUpdated' | 'isMainPicture'>
      & { file?: Maybe<(
        { __typename?: 'File' }
        & Pick<File, 'id' | 'key' | 'fileName' | 'url'>
      )> }
...
export type NcpOverallInfoQuery = (
  { __typename?: 'Query' }
  & { getNcp: (
    { __typename?: 'NcpGeneral' }
    & Pick<NcpGeneral, 'startSale' | 'startDelivery' | 'properties' | 'objectTypesCount' | 'projectType'>
  ), getNcpPrices: (
    { __typename?: 'NcpPricesResult' }
    & { pricing?: Maybe<(
      { __typename?: 'CommonPricing' }
...
export type GetNotificationsQuery = (
  ...
  & { getNotifications?: Maybe<(
    ...
    & { items?: Maybe<Array<(
      { __typename?: 'Notification' }
      & Pick<Notification, 'id' | 'type' | 'isRead' | 'isDeleted' | 'description' | 'dateCreated'>
      & { receiver: (
        { __typename?: 'Profile' }
        & Pick<Profile, 'id' | 'email' | 'isAdmin' | 'isActive'>
        & { image?: Maybe<(
          { __typename?: 'File' }
          & Pick<File, 'url'>
        )> }
...
export type ListNylasAccountQuery = (
  { __typename?: 'Query' }
  & { listNylasAccount?: Maybe<Array<(
    { __typename?: 'NylasAccountItem' }
    & Pick<NylasAccountItem, 'id' | 'email' | 'provider' | 'billingState' | 'syncState' | 'isCalendarConnected' | 'isEmailConnected'>
  )>> }
);
...
export type GetNylasAuthUrlQuery = (
  { __typename?: 'Query' }
  & Pick<Query, 'getNylasAuthUrl'>
);
...
export type ObjectTypeMediaQuery = (
  ...
  & { getObjectTypeMedia: (
    { __typename?: 'ObjectTypeMedia' }
    & Pick<ObjectTypeMedia, 'id' | 'mediaDescription' | 'dateUpdated'>
    & { lastEditedBy?: Maybe<(
      { __typename?: 'LastUpdatedProfile' }
      & Pick<LastUpdatedProfile, 'id' | 'firstName' | 'lastName'>
    )>, pictures?: Maybe<Array<(
      { __typename?: 'Picture' }
      & Pick<Picture, 'isMainPicture' | 'id' | 'name' | 'description' | 'type' | 'dateUpdated'>
      & { file?: Maybe<(
        { __typename?: 'File' }
...
export type PimMediaQuery = (
  ...
  & { getPimMedia: (
    { __typename?: 'PimMedia' }
    & Pick<PimMedia, 'id' | 'description' | 'dateUpdated'>
    & { lastEditedBy?: Maybe<(
      { __typename?: 'LastUpdatedProfile' }
      & Pick<LastUpdatedProfile, 'id' | 'firstName' | 'lastName'>
    )>, pictures?: Maybe<Array<(
...
export type MovePimDataQuery = (
  { __typename?: 'Query' }
  & { properties: (
    { __typename?: 'PimListSearchResult' }
    & { items?: Maybe<Array<(
      { __typename?: 'ListPim' }
      & Pick<ListPim, 'id' | 'street'>
    )>>, metadata?: Maybe<(
      { __typename?: 'SearchMetadata' }
      & Pick<SearchMetadata, 'total'>
    )> }
...
export type PimInfoQuery = (
  { __typename?: 'Query' }
  & { getPim?: Maybe<(
    { __typename?: 'Pim' }
    & Pick<Pim, 'street' | 'houseNumberPrefix' | 'houseNumber' | 'houseNumberAddition' | 'constructionNumber' | 'constructionNumberPrefix' | 'constructionNumberAddition' | 'city' | 'developmentType' | 'status' | 'salePrice' | 'rentPrice' | 'description' | 'livingArea' | 'propertyType' | 'attentionNote' | 'completeness' | 'archived'>
    & { houseGeneral?: Maybe<(
      { __typename?: 'HouseGeneral' }
      & Pick<HouseGeneral, 'floor' | 'propertyConnection' | 'propertyDetails'>
      & { availability?: Maybe<(
        { __typename?: 'PropertyAvailabilityInformation' }
        & Pick<PropertyAvailabilityInformation, 'availability' | 'from' | 'notes' | 'habitation' | 'currentUse' | 'currentDestination'>
      )>, construction?: Maybe<(
      ...
      & { generalInformation?: Maybe<(
        ...
        & { images?: Maybe<Array<(
          { __typename?: 'File' }
          & Pick<File, 'id' | 'fileName' | 'description' | 'status' | 'fileType' | 'permission' | 'key' | 'signedUrl' | 'url' | 'bucket'>
        )>> }
      )>, foundation?: Maybe<(
        { __typename?: 'Foundation' }
        & { type?: Maybe<(
          { __typename?: 'FoundationTypeInformations' }
          & Pick<FoundationTypeInformations, 'type' | 'notes'>
        )>, material?: Maybe<(
          { __typename?: 'FoundationMaterialInformations' }
          & Pick<FoundationMaterialInformations, 'type' | 'notes'>
        )> }
      )>, propertyRelated?: Maybe<(
        { __typename?: 'PropertyRelated' }
        & Pick<PropertyRelated, 'items' | 'notes'>
        ...
        & { type?: Maybe<(
          ...
          { __typename?: 'GutterInformations' }
          & Pick<GutterInformations, 'type' | 'notes'>
        )>, gutterMaterial?: Maybe<(
          { __typename?: 'GutterMaterialInformations' }
          & Pick<GutterMaterialInformations, 'material' | 'notes'>
        )> }
      ...
      { __typename?: 'Floor' }
      & Pick<Floor, 'id' | 'floorDescription' | 'level' | 'floorType'>
      & { spaces?: Maybe<Array<(
        { __typename?: 'Space' }
        & Pick<Space, 'id' | 'spaceType' | 'spaceName' | 'extraRoomPossibility'>
        & { configuration?: Maybe<(
          { __typename?: 'KitchenSpace' }
          & Pick<KitchenSpace, 'constructionYear' | 'notes' | 'constructionType' | 'servicesNotes' | 'hob' | 'shape' | 'serviceHeating'>
          & { kitchenType: KitchenSpace['type'], kitchenServices: KitchenSpace['services'] }
      ...
      { __typename?: 'InsideGeneral' }
      & Pick<InsideGeneral, 'notes'>
      & { windows?: Maybe<(
        { __typename?: 'InsideWindows' }
        & Pick<InsideWindows, 'types' | 'notes'>
      )>, extension?: Maybe<(
        { __typename?: 'Extension' }
        & Pick<Extension, 'yearOfExtension' | 'notes'>
      )>, renovation?: Maybe<(
        { __typename?: 'Renovation' }
        & Pick<Renovation, 'yearOfRenovation'>
      )> }
    )>, cadastre?: Maybe<Array<(
      { __typename?: 'Cadastre' }
      & Pick<Cadastre, 'id' | 'description' | 'mapsDescription' | 'type'>
      & { maps?: Maybe<Array<(
        { __typename?: 'CadastreMap' }
        & Pick<CadastreMap, 'id' | 'mapName' | 'name' | 'type'>
        & { file?: Maybe<(
          { __typename?: 'File' }
          & Pick<File, 'id' | 'fileName' | 'description' | 'status' | 'fileType' | 'permission' | 'key' | 'signedUrl' | 'url' | 'bucket'>
        )> }
      ...
      { __typename?: 'Picture' }
      & Pick<Picture, 'id' | 'description' | 'type' | 'name' | 'isMainPicture'>
      & { file?: Maybe<(
        { __typename?: 'File' }
        & Pick<File, 'id' | 'fileName' | 'description' | 'fileType' | 'permission' | 'key' | 'signedUrl' | 'url' | 'bucket'>
      )> }
    )>>, mainPicture?: Maybe<(
      { __typename?: 'Picture' }
      & Pick<Picture, 'id' | 'description' | 'type' | 'name'>
      & { file?: Maybe<(
        { __typename?: 'File' }
        & Pick<File, 'id' | 'fileName' | 'description' | 'fileType' | 'permission' | 'key' | 'signedUrl' | 'url' | 'bucket'>
      )> }
...
export type PimOverallInfoQuery = (
  ...
  & { getPimGeneral: (
    ...
    & { outsideFeatures?: Maybe<Array<(
      { __typename?: 'OutsideFeature' }
      & Pick<OutsideFeature, 'id' | 'type' | 'description'>
      & { configuration?: Maybe<(
        { __typename?: 'GardenFeature' }
        & Pick<GardenFeature, 'main' | 'type' | 'notes' | 'quality' | 'location' | 'shape'>
        & { measurement?: Maybe<(
        ...
        { __typename?: 'GarageFeature' }
        & Pick<GarageFeature, 'main' | 'attached' | 'attic' | 'secondaryWindows' | 'materials' | 'notes'>
        & { garageTypes: GarageFeature['types'], garageInsulations: GarageFeature['insulations'], garageServices: GarageFeature['services'] }
        & { measurement?: Maybe<(
          { __typename?: 'CuboidMeasurement' }
          & Pick<CuboidMeasurement, 'length' | 'width' | 'height' | 'surface' | 'volume'>
        ...
        { __typename?: 'StorageFeature' }
        & Pick<StorageFeature, 'main' | 'attached' | 'materials' | 'secondaryWindows' | 'notes'>
        & { storageTypes: StorageFeature['types'], storageInsulations: StorageFeature['insulations'], storageServices: StorageFeature['services'] }
        & { measurement?: Maybe<(
          { __typename?: 'CuboidMeasurement' }
          & Pick<CuboidMeasurement, 'length' | 'width' | 'height' | 'surface' | 'volume'>
...
export type MeQuery = (
  ...
  & { me?: Maybe<(
    { __typename?: 'Profile' }
    & Pick<Profile, 'id' | 'firstName' | 'lastName' | 'email' | 'adminSettings' | 'isActive' | 'isAdmin' | 'language'>
    & { company?: Maybe<(
      { __typename?: 'Company' }
      & Pick<Company, 'id'>
    )>, image?: Maybe<(
...
export type GetUsersQuery = (
  ...
  & { getAllProfiles: (
    ...
    & { items?: Maybe<Array<(
      { __typename?: 'Profile' }
      & Pick<Profile, 'id' | 'firstName' | 'lastName' | 'email' | 'functionDescription' | 'adminSettings' | 'isActive' | 'isAdmin'>
      & { image?: Maybe<(
        { __typename?: 'File' }
        & Pick<File, 'id' | 'key' | 'url'>
      )>, teams?: Maybe<Array<(
...
export type GetUserProfileQuery = (
  ...
  & { getProfile?: Maybe<(
    { __typename?: 'Profile' }
    & Pick<Profile, 'id' | 'firstName' | 'lastName' | 'email' | 'gender' | 'dateOfBirth' | 'functionDescription' | 'initials' | 'costUnit' | 'hideOnMemos' | 'isAccountmanager' | 'adminSettings' | 'isAdmin' | 'isActive' | 'language'>
    & { image?: Maybe<(
      { __typename?: 'File' }
      & Pick<File, 'id' | 'key' | 'url'>
    )>, teams?: Maybe<Array<(
      { __typename?: 'ProfileTeam' }
      & Pick<ProfileTeam, 'id' | 'name' | 'createPermission' | 'readPermission' | 'updatePermission' | 'deletePermission'>
    )>>, emailAddresses?: Maybe<Array<(
      { __typename?: 'EmailAddress' }
      & Pick<EmailAddress, 'id' | 'emailAddress' | 'emailAddressType' | 'isPublic'>
    )>>, phoneNumbers?: Maybe<Array<(
      { __typename?: 'PhoneNumber' }
      & Pick<PhoneNumber, 'id' | 'phoneNumber' | 'phoneNumberType' | 'isPublic'>
    )>>, socialMediaLinks?: Maybe<Array<(
      { __typename?: 'SocialMediaLink' }
      & Pick<SocialMediaLink, 'id' | 'socialMediaLink' | 'socialMediaLinkType' | 'isPublic'>
    )>>, company?: Maybe<(
      { __typename?: 'Company' }
...
export type GetMyTeamMembersQuery = (
  { __typename?: 'Query' }
  & { members: (
    { __typename?: 'ProfileSearchResult' }
    & { items?: Maybe<Array<(
      { __typename?: 'Profile' }
      & Pick<Profile, 'id' | 'firstName' | 'lastName' | 'isAdmin' | 'email'>
      & { image?: Maybe<(
        { __typename?: 'File' }
        & Pick<File, 'id' | 'key' | 'url'>
      )> }
...
export type SearchQuery = (
  ...
  & { search?: Maybe<(
    ...
    & { users?: Maybe<Array<(
      ...
      { __typename?: 'CrmListItem' }
      & Pick<CrmListItem, 'id' | 'type' | 'firstName' | 'initials' | 'lastName' | 'phoneNumber' | 'email'>
      & { avatar?: Maybe<(
        { __typename?: 'File' }
        & Pick<File, 'url'>
      )> }
      ...
      { __typename?: 'Pim' }
      & Pick<Pim, 'id' | 'street' | 'houseNumber' | 'district' | 'city' | 'state' | 'country' | 'county' | 'propertyType'>
    )>>, ncps?: Maybe<Array<(
      { __typename?: 'ListNcp' }
      & Pick<ListNcp, 'id' | 'dateCreated' | 'dateUpdated' | 'archived' | 'areaRangeFrom' | 'areaRangeTo' | 'numberOfRoomsFrom' | 'numberOfRoomsTo' | 'name' | 'salePriceFrom' | 'salePriceTo' | 'rentPriceFrom' | 'rentPriceTo' | 'saleLabel' | 'rentLabel' | 'partOfPhase' | 'soldNumber' | 'rentNumber' | 'completeness' | 'available' | 'underOption' | 'soldOrRent' | 'matches' | 'interests' | 'candidates' | 'optants' | 'properties' | 'objectTypesCount' | 'attentionNote' | 'projectType'>
      & { logoPicture?: Maybe<(
...
export type GetTaskLabelsQuery = (
  { __typename?: 'Query' }
  & { getTaskLabels?: Maybe<Array<(
    { __typename?: 'Label' }
    & Pick<Label, 'id' | 'property' | 'icon' | 'text'>
  )>> }
);
...
export type GetTaskQuery = (
  ...
  & { getTask?: Maybe<(
    { __typename?: 'Task' }
    & Pick<Task, 'id' | 'taskIndex' | 'title' | 'assignee' | 'startDate' | 'deadline' | 'priority' | 'label' | 'status' | 'description' | 'originalEstimate' | 'resultIntern' | 'resultClient' | 'dateUpdated'>
    & { logs?: Maybe<Array<(
      { __typename?: 'TaskLog' }
      & Pick<TaskLog, 'timeSpent' | 'dateStarted' | 'notes'>
    )>>, subTasks?: Maybe<Array<(
      { __typename?: 'Subtask' }
      & Pick<Subtask, 'id' | 'title' | 'status' | 'dateUpdated'>
      & { lastEditedBy?: Maybe<(
        { __typename?: 'LastUpdatedProfile' }
        & Pick<LastUpdatedProfile, 'id' | 'firstName' | 'lastName'>
      )> }
...
export type GetTasksFullSummaryQuery = (
  { __typename?: 'Query' }
  & { getTasksFullSummary?: Maybe<(
    { __typename?: 'TaskFullSummaryResult' }
    & Pick<TaskFullSummaryResult, 'today' | 'nextWeek' | 'future' | 'overdue'>
  )> }
);
...
export type GetTasksSummaryByStatusQuery = (
  { __typename?: 'Query' }
  & { getTasksSummaryByStatus?: Maybe<(
    { __typename?: 'TaskSummaryByStatusResult' }
    & Pick<TaskSummaryByStatusResult, 'todo' | 'inProgress' | 'blocked' | 'done'>
  )> }
);
...
export type GetTeamsQuery = (
  ...
  & { getTeams?: Maybe<(
    ...
    & { items?: Maybe<Array<(
      { __typename?: 'Team' }
      & Pick<Team, 'id' | 'name' | 'description' | 'teamRights'>
      & { profileMembers?: Maybe<Array<(
        { __typename?: 'TeamMember' }
        & Pick<TeamMember, 'id'>
        & { user: (
          { __typename?: 'Profile' }
          & Pick<Profile, 'id' | 'firstName' | 'lastName' | 'isActive'>
        ) }
      )>>, company: (
        { __typename?: 'Company' }
        & Pick<Company, 'id' | 'name'>
...
export type GetTeamDetailsQuery = (
  ...
  & { getTeamDetails?: Maybe<(
    { __typename?: 'Team' }
    & Pick<Team, 'id' | 'name' | 'teamRights'>
    & { company: (
      { __typename?: 'Company' }
      & Pick<Company, 'id' | 'name'>
    ), profileMembers?: Maybe<Array<(
      { __typename?: 'TeamMember' }
      & Pick<TeamMember, 'id' | 'notes' | 'createPermission' | 'readPermission' | 'updatePermission' | 'deletePermission'>
      & { user: (
        { __typename?: 'Profile' }
        & Pick<Profile, 'id' | 'email' | 'firstName' | 'lastName' | 'isActive'>
      ) }
    )>> }
  )> }
);
...
export type GetQuestionaireQuery = (
  ...
  & { getQuestionaire?: Maybe<(
    { __typename?: 'Questionaire' }
    & Pick<Questionaire, 'id' | 'templateName' | 'isAdmin' | 'published' | 'copyFromId' | 'templateStatus' | 'type'>
    & { entity?: Maybe<(
      { __typename?: 'Entity' }
      & Pick<Entity, 'type' | 'subType'>
    )>, settings?: Maybe<(
      { __typename?: 'TemplateSettings' }
      & Pick<TemplateSettings, 'description' | 'version' | 'language' | 'documentType'>
    )>, permissions?: Maybe<Array<(
      { __typename?: 'TemplateSecurity' }
      & Pick<TemplateSecurity, 'name' | 'create' | 'update' | 'read' | 'delete'>
    )>>, meta: (
      { __typename?: 'TemplateMeta' }
      & Pick<TemplateMeta, 'createdAt'>
    ) }
  )> }
);
...
export type ListQuestionaireGroupsQuery = (
  { __typename?: 'Query' }
  & { listQuestionaireGroups?: Maybe<Array<(
    { __typename?: 'Groups' }
    & Pick<Groups, 'id' | 'templateId' | 'groupName' | 'copyFromId' | 'order'>
    & { entity?: Maybe<(
      { __typename?: 'Entity' }
...
export type GetQuestionairesQuery = (
  { __typename?: 'Query' }
  & { getQuestionaires: (
    { __typename?: 'TemplatesResponse' }
    & Pick<TemplatesResponse, 'count'>
    & { items?: Maybe<Array<(
      { __typename?: 'Questionaire' }
      & Pick<Questionaire, 'id' | 'templateName' | 'isAdmin' | 'published' | 'copyFromId' | 'templateStatus' | 'type' | 'labels'>
      & { entity?: Maybe<(
        { __typename?: 'Entity' }
        & Pick<Entity, 'type' | 'subType'>
      )>, settings?: Maybe<(
...
export type GetQuestionaireGroupQuery = (
  { __typename?: 'Query' }
...
export type GetQuestionairesCountQuery = (
  { __typename?: 'Query' }
  & { active: (
    { __typename?: 'TemplatesResponse' }
    & Pick<TemplatesResponse, 'count'>
...
export type GetTiaraMutationsQuery = (
  { __typename?: 'Query' }
  & { getTiaraMutations?: Maybe<Array<(
    { __typename?: 'TiaraMutation' }
    & Pick<TiaraMutation, 'id' | 'status' | 'errors' | 'messageType' | 'date'>
  )>> }
);
...
export type GetTiaraValidationQuery = (
  { __typename?: 'Query' }
  & { getTiaraValidation: (
    { __typename?: 'TiaraValidation' }
    & Pick<TiaraValidation, 'errors'>
  ) }
);
...
export const AddAllocateDocument = gql`
  ...
  addAllocate(input: $input) @rest(type: "Allocate", path: "/create-allocate", method: "POST", endpoint: "default") {
    ...
    `;
export function useAddAllocateMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddAllocateMutation, AddAllocateMutationVariables>) {
        return ApolloReactHooks.useMutation<AddAllocateMutation, AddAllocateMutationVariables>(AddAllocateDocument, baseOptions);
      }
...
export type AddAllocateMutationOptions = ApolloReactCommon.BaseMutationOptions<AddAllocateMutation, AddAllocateMutationVariables>;
export const UpdateAllocateDocument = gql`
    mutation UpdateAllocate($id: ID!, $input: AllocateInput!) {
  updateAllocate(id: $id, input: $input) @rest(type: "UpdateAllocateResponse", path: "/update-allocate?id={args.id}", method: "PUT", endpoint: "default") {
    id
  }
}
    `;
export function useUpdateAllocateMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateAllocateMutation, UpdateAllocateMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateAllocateMutation, UpdateAllocateMutationVariables>(UpdateAllocateDocument, baseOptions);
      }
...
export type UpdateAllocateMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateAllocateMutation, UpdateAllocateMutationVariables>;
export const DeleteAllocateDocument = gql`
    mutation DeleteAllocate($id: ID!) {
  deleteAllocate(id: $id) @rest(type: "DeleteAllocateResponse", path: "/delete-allocate?id={args.id}", method: "DELETE", endpoint: "default")
}
    `;
export function useDeleteAllocateMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<DeleteAllocateMutation, DeleteAllocateMutationVariables>) {
        return ApolloReactHooks.useMutation<DeleteAllocateMutation, DeleteAllocateMutationVariables>(DeleteAllocateDocument, baseOptions);
      }
...
export type DeleteAllocateMutationOptions = ApolloReactCommon.BaseMutationOptions<DeleteAllocateMutation, DeleteAllocateMutationVariables>;
...
export const ForgotPasswordDocument = gql`
  ...
  forgotPassword(input: $input) @rest(type: "ForgotPasswordResponse", path: "/forgot_password", method: "POST", endpoint: "default") {
    error
  }
}
    `;
...
export const ResetPasswordDocument = gql`
  ...
  resetPassword(input: $input) @rest(type: "ResetPasswordResponse", path: "/forgot_password/confirm", method: "POST", endpoint: "default") {
    error
  }
}
    `;
...
export const AddAppointmentDocument = gql`
  ...
  addAppointment(input: $input) @rest(type: "AddAppointment", path: "/calendar-addappointment", method: "POST", endpoint: "default") {
    id
    from
    to
    travelTimeBefore
    ...
    `;
export function useAddAppointmentMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddAppointmentMutation, AddAppointmentMutationVariables>) {
        return ApolloReactHooks.useMutation<AddAppointmentMutation, AddAppointmentMutationVariables>(AddAppointmentDocument, baseOptions);
      }
...
export type AddAppointmentMutationOptions = ApolloReactCommon.BaseMutationOptions<AddAppointmentMutation, AddAppointmentMutationVariables>;
...
export const UpdateCrmContactInformationDocument = gql`
  ...
  updateCrmContactInformation(input: $input) {
    ...
    `;
export function useUpdateCrmContactInformationMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateCrmContactInformationMutation, UpdateCrmContactInformationMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateCrmContactInformationMutation, UpdateCrmContactInformationMutationVariables>(UpdateCrmContactInformationDocument, baseOptions);
      }
export type UpdateCrmContactInformationMutationHookResult = ReturnType<typeof useUpdateCrmContactInformationMutation>;
export type UpdateCrmContactInformationMutationResult = ApolloReactCommon.MutationResult<UpdateCrmContactInformationMutation>;
export type UpdateCrmContactInformationMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateCrmContactInformationMutation, UpdateCrmContactInformationMutationVariables>;
export const UpdateCrmFamilyContactsDocument = gql`
  ...
  updateCrmFamilyContacts(input: $input) {
    ...
    `;
export function useUpdateCrmFamilyContactsMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateCrmFamilyContactsMutation, UpdateCrmFamilyContactsMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateCrmFamilyContactsMutation, UpdateCrmFamilyContactsMutationVariables>(UpdateCrmFamilyContactsDocument, baseOptions);
      }
...
export type UpdateCrmFamilyContactsMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateCrmFamilyContactsMutation, UpdateCrmFamilyContactsMutationVariables>;
export const UpdateCrmFinancialDocument = gql`
  ...
  updateCrmFinancial(input: $input) {
    ...
    `;
export function useUpdateCrmFinancialMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateCrmFinancialMutation, UpdateCrmFinancialMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateCrmFinancialMutation, UpdateCrmFinancialMutationVariables>(UpdateCrmFinancialDocument, baseOptions);
      }
...
export type UpdateCrmFinancialMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateCrmFinancialMutation, UpdateCrmFinancialMutationVariables>;
export const CreateCrmDocument = gql`
  ...
  createCrm(input: $input) {
    ...
    `;
export function useCreateCrmMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateCrmMutation, CreateCrmMutationVariables>) {
...
export type CreateCrmMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateCrmMutation, CreateCrmMutationVariables>;
export const UpdateCrmGeneralDocument = gql`
  ...
  updateCrmGeneral(input: $input) {
    ...
    `;
export function useUpdateCrmGeneralMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateCrmGeneralMutation, UpdateCrmGeneralMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateCrmGeneralMutation, UpdateCrmGeneralMutationVariables>(UpdateCrmGeneralDocument, baseOptions);
      }
...
export type UpdateCrmGeneralMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateCrmGeneralMutation, UpdateCrmGeneralMutationVariables>;
export const UpdateCrmHomeSituationDocument = gql`
  ...
  updateCrmHomeSituation(input: $input) {
    ...
    `;
export function useUpdateCrmHomeSituationMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateCrmHomeSituationMutation, UpdateCrmHomeSituationMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateCrmHomeSituationMutation, UpdateCrmHomeSituationMutationVariables>(UpdateCrmHomeSituationDocument, baseOptions);
      }
...
export const CreateDmsFileDocument = gql`
  ...
  createDmsFile(input: $input) @rest(type: "CreateDmsFile", path: "/dms/files/create", method: "POST", endpoint: "default") {
    id
    signedUrl
  }
}
    `;
export function useCreateDmsFileMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateDmsFileMutation, CreateDmsFileMutationVariables>) {
        return ApolloReactHooks.useMutation<CreateDmsFileMutation, CreateDmsFileMutationVariables>(CreateDmsFileDocument, baseOptions);
      }
...
export type CreateDmsFileMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateDmsFileMutation, CreateDmsFileMutationVariables>;
export const CreateDmsFolderDocument = gql`
    mutation CreateDmsFolder($input: CreateDmsFolderInput!) {
  createDmsFolder(input: $input) @rest(type: "CreateDmsFolder", path: "/dms/folders/create", method: "POST", endpoint: "default") {
    id
  }
}
    `;
export function useCreateDmsFolderMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateDmsFolderMutation, CreateDmsFolderMutationVariables>) {
        return ApolloReactHooks.useMutation<CreateDmsFolderMutation, CreateDmsFolderMutationVariables>(CreateDmsFolderDocument, baseOptions);
      }
...
export type CreateDmsFolderMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateDmsFolderMutation, CreateDmsFolderMutationVariables>;
...
export const UpdateKikSettingsDocument = gql`
  ...
  updateKikSettings(input: $input)
    ...
    `;
export function useUpdateKikSettingsMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateKikSettingsMutation, UpdateKikSettingsMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateKikSettingsMutation, UpdateKikSettingsMutationVariables>(UpdateKikSettingsDocument, baseOptions);
      }
...
export type UpdateKikSettingsMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateKikSettingsMutation, UpdateKikSettingsMutationVariables>;
export const UpdateKikInfoDocument = gql`
    mutation UpdateKikInfo($input: KikInfoInput!) {
  updateKikInfo(input: $input)
}
    `;
export function useUpdateKikInfoMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateKikInfoMutation, UpdateKikInfoMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateKikInfoMutation, UpdateKikInfoMutationVariables>(UpdateKikInfoDocument, baseOptions);
      }
...
export type UpdateKikInfoMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateKikInfoMutation, UpdateKikInfoMutationVariables>;
...
export const AddCrmLabelDocument = gql`
  ...
  addCrmLabel(input: $input) {
    ...
    `;
export function useAddCrmLabelMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddCrmLabelMutation, AddCrmLabelMutationVariables>) {
        return ApolloReactHooks.useMutation<AddCrmLabelMutation, AddCrmLabelMutationVariables>(AddCrmLabelDocument, baseOptions);
      }
...
export type AddCrmLabelMutationOptions = ApolloReactCommon.BaseMutationOptions<AddCrmLabelMutation, AddCrmLabelMutationVariables>;
export const AddMatchProfileDocument = gql`
    mutation AddMatchProfile($input: AddMatchProfileInput!) {
  addMatchProfile(input: $input) @rest(type: "AddMatchResponse", path: "/create-match", method: "POST", endpoint: "default") {
    id
    crmId
    companyId
    propertyType
    ...
    `;
export function useAddMatchProfileMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddMatchProfileMutation, AddMatchProfileMutationVariables>) {
        return ApolloReactHooks.useMutation<AddMatchProfileMutation, AddMatchProfileMutationVariables>(AddMatchProfileDocument, baseOptions);
      }
...
export type AddMatchProfileMutationOptions = ApolloReactCommon.BaseMutationOptions<AddMatchProfileMutation, AddMatchProfileMutationVariables>;
export const CloneMatchProfileDocument = gql`
    mutation CloneMatchProfile($input: CloneMatchProfileInput!) {
  cloneMatchProfile(input: $input) @rest(type: "CloneMatchResponse", path: "/clone-match", method: "POST", endpoint: "default") {
    id
    crmId
    companyId
    propertyType
    ...
    `;
export function useCloneMatchProfileMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CloneMatchProfileMutation, CloneMatchProfileMutationVariables>) {
        return ApolloReactHooks.useMutation<CloneMatchProfileMutation, CloneMatchProfileMutationVariables>(CloneMatchProfileDocument, baseOptions);
      }
...
export type CloneMatchProfileMutationOptions = ApolloReactCommon.BaseMutationOptions<CloneMatchProfileMutation, CloneMatchProfileMutationVariables>;
export const UpdateMatchProfileDocument = gql`
    mutation UpdateMatchProfile($id: ID!, $input: UpdateMatchProfileInput!) {
  updateMatchProfile(id: $id, input: $input) @rest(type: "UpdateMatchResponse", path: "/update-match?id={args.id}", method: "PUT", endpoint: "default") {
    id
    crmId
    companyId
    propertyType
    ...
    `;
export function useUpdateMatchProfileMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateMatchProfileMutation, UpdateMatchProfileMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateMatchProfileMutation, UpdateMatchProfileMutationVariables>(UpdateMatchProfileDocument, baseOptions);
      }
...
export type UpdateMatchProfileMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateMatchProfileMutation, UpdateMatchProfileMutationVariables>;
export const DeleteMatchProfileDocument = gql`
    mutation DeleteMatchProfile($id: ID!) {
  deleteMatchProfile(id: $id) @rest(type: "DeleteMatchProfileResponse", path: "/delete-match?id={args.id}", method: "DELETE", endpoint: "default")
}
    `;
export function useDeleteMatchProfileMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<DeleteMatchProfileMutation, DeleteMatchProfileMutationVariables>) {
        return ApolloReactHooks.useMutation<DeleteMatchProfileMutation, DeleteMatchProfileMutationVariables>(DeleteMatchProfileDocument, baseOptions);
      }
...
export type DeleteMatchProfileMutationOptions = ApolloReactCommon.BaseMutationOptions<DeleteMatchProfileMutation, DeleteMatchProfileMutationVariables>;
...
export const BulkReadNotificationsDocument = gql`
  ...
  bulkReadNotifications(input: $input)
    ...
    `;
export function useBulkReadNotificationsMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<BulkReadNotificationsMutation, BulkReadNotificationsMutationVariables>) {
        return ApolloReactHooks.useMutation<BulkReadNotificationsMutation, BulkReadNotificationsMutationVariables>(BulkReadNotificationsDocument, baseOptions);
      }
...
export type BulkReadNotificationsMutationOptions = ApolloReactCommon.BaseMutationOptions<BulkReadNotificationsMutation, BulkReadNotificationsMutationVariables>;
export const BulkDeleteNotificationsDocument = gql`
  ...
  bulkDeleteNotifications(input: $input)
    ...
    `;
export function useBulkDeleteNotificationsMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<BulkDeleteNotificationsMutation, BulkDeleteNotificationsMutationVariables>) {
        return ApolloReactHooks.useMutation<BulkDeleteNotificationsMutation, BulkDeleteNotificationsMutationVariables>(BulkDeleteNotificationsDocument, baseOptions);
      }
...
export type BulkDeleteNotificationsMutationOptions = ApolloReactCommon.BaseMutationOptions<BulkDeleteNotificationsMutation, BulkDeleteNotificationsMutationVariables>;
export const AuthorizeNylasAccountDocument = gql`
    mutation AuthorizeNylasAccount($input: NylasAuthorizationInput!, $isCalendarConnected: Boolean, $isEmailConnected: Boolean) {
  authorizeNylasAccount(input: $input, isCalendarConnected: $isCalendarConnected, isEmailConnected: $isEmailConnected)
}
    `;
export function useAuthorizeNylasAccountMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AuthorizeNylasAccountMutation, AuthorizeNylasAccountMutationVariables>) {
        return ApolloReactHooks.useMutation<AuthorizeNylasAccountMutation, AuthorizeNylasAccountMutationVariables>(AuthorizeNylasAccountDocument, baseOptions);
      }
...
export type AuthorizeNylasAccountMutationOptions = ApolloReactCommon.BaseMutationOptions<AuthorizeNylasAccountMutation, AuthorizeNylasAccountMutationVariables>;
export const AuthorizeNylasAccountWithTokenDocument = gql`
  ...
  authorizeNylasAccountWithToken(input: $input) @rest(type: "CreateNylasAccount", path: "/nylas-addaccount", method: "POST", endpoint: "default") {
    id
    userId
    accountId
    accessToken
    ...
    `;
export function useAuthorizeNylasAccountWithTokenMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AuthorizeNylasAccountWithTokenMutation, AuthorizeNylasAccountWithTokenMutationVariables>) {
        return ApolloReactHooks.useMutation<AuthorizeNylasAccountWithTokenMutation, AuthorizeNylasAccountWithTokenMutationVariables>(AuthorizeNylasAccountWithTokenDocument, baseOptions);
      }
export type AuthorizeNylasAccountWithTokenMutationHookResult = ReturnType<typeof useAuthorizeNylasAccountWithTokenMutation>;
export type AuthorizeNylasAccountWithTokenMutationResult = ApolloReactCommon.MutationResult<AuthorizeNylasAccountWithTokenMutation>;
export type AuthorizeNylasAccountWithTokenMutationOptions = ApolloReactCommon.BaseMutationOptions<AuthorizeNylasAccountWithTokenMutation, AuthorizeNylasAccountWithTokenMutationVariables>;
...
export const ConfirmProfileInviteDocument = gql`
  ...
  confirmProfileInvite(input: $input) {
    ...
    `;
export function useConfirmProfileInviteMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ConfirmProfileInviteMutation, ConfirmProfileInviteMutationVariables>) {
        return ApolloReactHooks.useMutation<ConfirmProfileInviteMutation, ConfirmProfileInviteMutationVariables>(ConfirmProfileInviteDocument, baseOptions);
      }
...
export type ConfirmProfileInviteMutationOptions = ApolloReactCommon.BaseMutationOptions<ConfirmProfileInviteMutation, ConfirmProfileInviteMutationVariables>;
export const DeactivateProfileDocument = gql`
  ...
  deactivateProfile(id: $id) {
    ...
    `;
export function useDeactivateProfileMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<DeactivateProfileMutation, DeactivateProfileMutationVariables>) {
        return ApolloReactHooks.useMutation<DeactivateProfileMutation, DeactivateProfileMutationVariables>(DeactivateProfileDocument, baseOptions);
      }
...
export type DeactivateProfileMutationOptions = ApolloReactCommon.BaseMutationOptions<DeactivateProfileMutation, DeactivateProfileMutationVariables>;
export const ReactivateProfileDocument = gql`
  ...
  reactivateProfile(id: $id) {
    ...
    `;
export function useReactivateProfileMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ReactivateProfileMutation, ReactivateProfileMutationVariables>) {
        return ApolloReactHooks.useMutation<ReactivateProfileMutation, ReactivateProfileMutationVariables>(ReactivateProfileDocument, baseOptions);
      }
...
export type ReactivateProfileMutationOptions = ApolloReactCommon.BaseMutationOptions<ReactivateProfileMutation, ReactivateProfileMutationVariables>;
export const CreateEmailAddressDocument = gql`
  ...
  createEmailAddress(input: $input) {
    ...
    `;
export function useCreateEmailAddressMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateEmailAddressMutation, CreateEmailAddressMutationVariables>) {
        return ApolloReactHooks.useMutation<CreateEmailAddressMutation, CreateEmailAddressMutationVariables>(CreateEmailAddressDocument, baseOptions);
      }
...
export type CreateEmailAddressMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateEmailAddressMutation, CreateEmailAddressMutationVariables>;
export const UpdateEmailAddressDocument = gql`
  ...
  updateEmailAddress(input: $input) {
    ...
    `;
export function useUpdateEmailAddressMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateEmailAddressMutation, UpdateEmailAddressMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateEmailAddressMutation, UpdateEmailAddressMutationVariables>(UpdateEmailAddressDocument, baseOptions);
      }
...
export type UpdateEmailAddressMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateEmailAddressMutation, UpdateEmailAddressMutationVariables>;
export const CreatePhoneNumberDocument = gql`
  ...
  createPhoneNumber(input: $input) {
    ...
    `;
export function useCreatePhoneNumberMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreatePhoneNumberMutation, CreatePhoneNumberMutationVariables>) {
        return ApolloReactHooks.useMutation<CreatePhoneNumberMutation, CreatePhoneNumberMutationVariables>(CreatePhoneNumberDocument, baseOptions);
      }
...
export type CreatePhoneNumberMutationOptions = ApolloReactCommon.BaseMutationOptions<CreatePhoneNumberMutation, CreatePhoneNumberMutationVariables>;
export const UpdatePhoneNumberDocument = gql`
  ...
  updatePhoneNumber(input: $input) {
    ...
    `;
export function useUpdatePhoneNumberMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdatePhoneNumberMutation, UpdatePhoneNumberMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdatePhoneNumberMutation, UpdatePhoneNumberMutationVariables>(UpdatePhoneNumberDocument, baseOptions);
      }
...
export type UpdatePhoneNumberMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdatePhoneNumberMutation, UpdatePhoneNumberMutationVariables>;
export const CreateSocialMediaLinkDocument = gql`
  ...
  createSocialMediaLink(input: $input) {
    ...
    `;
export function useCreateSocialMediaLinkMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateSocialMediaLinkMutation, CreateSocialMediaLinkMutationVariables>) {
        return ApolloReactHooks.useMutation<CreateSocialMediaLinkMutation, CreateSocialMediaLinkMutationVariables>(CreateSocialMediaLinkDocument, baseOptions);
      }
...
export type CreateSocialMediaLinkMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateSocialMediaLinkMutation, CreateSocialMediaLinkMutationVariables>;
export const UpdateSocialMediaLinkDocument = gql`
  ...
  updateSocialMediaLink(input: $input) {
    ...
    `;
export function useUpdateSocialMediaLinkMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateSocialMediaLinkMutation, UpdateSocialMediaLinkMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateSocialMediaLinkMutation, UpdateSocialMediaLinkMutationVariables>(UpdateSocialMediaLinkDocument, baseOptions);
      }
...
export type UpdateSocialMediaLinkMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateSocialMediaLinkMutation, UpdateSocialMediaLinkMutationVariables>;
...
export const CreateSalesDocument = gql`
  ...
  createSales(input: $input) @rest(type: "CreateSales", path: "/create-sales", method: "POST", endpoint: "default") {
    ...
    `;
export function useCreateSalesMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateSalesMutation, CreateSalesMutationVariables>) {
        return ApolloReactHooks.useMutation<CreateSalesMutation, CreateSalesMutationVariables>(CreateSalesDocument, baseOptions);
      }
...
export type CreateSalesMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateSalesMutation, CreateSalesMutationVariables>;
export const AddTaskLabelDocument = gql`
  ...
  addTaskLabel(input: $input) {
    ...
    `;
export function useAddTaskLabelMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddTaskLabelMutation, AddTaskLabelMutationVariables>) {
        return ApolloReactHooks.useMutation<AddTaskLabelMutation, AddTaskLabelMutationVariables>(AddTaskLabelDocument, baseOptions);
      }
...
export type AddTaskLabelMutationOptions = ApolloReactCommon.BaseMutationOptions<AddTaskLabelMutation, AddTaskLabelMutationVariables>;
...
export const AddNewSubtaskDocument = gql`
  ...
  addSubtask(taskId: $taskId, input: {title: $title}) {
    ...
    `;
export function useAddNewSubtaskMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddNewSubtaskMutation, AddNewSubtaskMutationVariables>) {
        return ApolloReactHooks.useMutation<AddNewSubtaskMutation, AddNewSubtaskMutationVariables>(AddNewSubtaskDocument, baseOptions);
      }
...
export type AddNewSubtaskMutationOptions = ApolloReactCommon.BaseMutationOptions<AddNewSubtaskMutation, AddNewSubtaskMutationVariables>;
export const UpdateSubtaskStatusDocument = gql`
  ...
  updateSubtaskStatus(subtaskId: $subtaskId, status: $status) {
    ...
    `;
export function useUpdateSubtaskStatusMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateSubtaskStatusMutation, UpdateSubtaskStatusMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateSubtaskStatusMutation, UpdateSubtaskStatusMutationVariables>(UpdateSubtaskStatusDocument, baseOptions);
      }
...
export type UpdateSubtaskStatusMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateSubtaskStatusMutation, UpdateSubtaskStatusMutationVariables>;
export const DeleteSubtaskDocument = gql`
  ...
  deleteSubtask(subtaskId: $subtaskId) {
    ...
    `;
export function useDeleteSubtaskMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<DeleteSubtaskMutation, DeleteSubtaskMutationVariables>) {
        return ApolloReactHooks.useMutation<DeleteSubtaskMutation, DeleteSubtaskMutationVariables>(DeleteSubtaskDocument, baseOptions);
      }
...
export type DeleteSubtaskMutationOptions = ApolloReactCommon.BaseMutationOptions<DeleteSubtaskMutation, DeleteSubtaskMutationVariables>;
...
export const RemoveTeamDocument = gql`
  ...
  removeTeam(id: $id)
    ...
    `;
export function useRemoveTeamMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RemoveTeamMutation, RemoveTeamMutationVariables>) {
...
export type RemoveTeamMutationOptions = ApolloReactCommon.BaseMutationOptions<RemoveTeamMutation, RemoveTeamMutationVariables>;
export const AddUserToTeamDocument = gql`
  ...
  addUserToTeam(input: $input) {
    ...
    `;
export function useAddUserToTeamMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddUserToTeamMutation, AddUserToTeamMutationVariables>) {
        return ApolloReactHooks.useMutation<AddUserToTeamMutation, AddUserToTeamMutationVariables>(AddUserToTeamDocument, baseOptions);
      }
...
export type AddUserToTeamMutationOptions = ApolloReactCommon.BaseMutationOptions<AddUserToTeamMutation, AddUserToTeamMutationVariables>;
export const RemoveUserFromTeamDocument = gql`
  ...
  removeUserFromTeam(input: $input) {
    ...
    `;
export function useRemoveUserFromTeamMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RemoveUserFromTeamMutation, RemoveUserFromTeamMutationVariables>) {
        return ApolloReactHooks.useMutation<RemoveUserFromTeamMutation, RemoveUserFromTeamMutationVariables>(RemoveUserFromTeamDocument, baseOptions);
      }
...
export type RemoveUserFromTeamMutationOptions = ApolloReactCommon.BaseMutationOptions<RemoveUserFromTeamMutation, RemoveUserFromTeamMutationVariables>;
export const UpdateUserInTeamDocument = gql`
  ...
  updateUserInTeam(input: $input) {
    ...
    `;
export function useUpdateUserInTeamMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateUserInTeamMutation, UpdateUserInTeamMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateUserInTeamMutation, UpdateUserInTeamMutationVariables>(UpdateUserInTeamDocument, baseOptions);
      }
...
export type UpdateUserInTeamMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateUserInTeamMutation, UpdateUserInTeamMutationVariables>;
export const CreateQuestionaireDocument = gql`
    mutation CreateQuestionaire($input: QuestionaireInput!) {
  createQuestionaire(input: $input) @rest(type: "Questionaire", path: "/template", method: "POST", endpoint: "default") {
    id
    templateName
    templateStatus
    isAdmin
    ...
    `;
export function useCreateQuestionaireMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateQuestionaireMutation, CreateQuestionaireMutationVariables>) {
        return ApolloReactHooks.useMutation<CreateQuestionaireMutation, CreateQuestionaireMutationVariables>(CreateQuestionaireDocument, baseOptions);
      }
...
export type CreateQuestionaireMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateQuestionaireMutation, CreateQuestionaireMutationVariables>;
export const UpdateQuestionaireDocument = gql`
    mutation UpdateQuestionaire($input: UpdateQuestionaireInput!) {
  updateQuestionaire(input: $input) @rest(type: "UpdateQuestionaire", path: "/template", method: "PUT", endpoint: "default") {
    id
    templateName
    templateStatus
    isAdmin
    ...
    `;
export function useUpdateQuestionaireMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateQuestionaireMutation, UpdateQuestionaireMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateQuestionaireMutation, UpdateQuestionaireMutationVariables>(UpdateQuestionaireDocument, baseOptions);
      }
...
export type UpdateQuestionaireMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateQuestionaireMutation, UpdateQuestionaireMutationVariables>;
export const UpdateTemplateGeneralDocument = gql`
    mutation UpdateTemplateGeneral($input: TemplateGeneralInput!) {
  updateTemplateGeneral(input: $input) @rest(type: "Template", path: "/template", method: "PUT", endpoint: "default") {
    id
  }
}
    `;
export function useUpdateTemplateGeneralMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateTemplateGeneralMutation, UpdateTemplateGeneralMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateTemplateGeneralMutation, UpdateTemplateGeneralMutationVariables>(UpdateTemplateGeneralDocument, baseOptions);
      }
...
export type UpdateTemplateGeneralMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateTemplateGeneralMutation, UpdateTemplateGeneralMutationVariables>;
export const CreateQuestionaireGroupDocument = gql`
    mutation CreateQuestionaireGroup($input: GroupsInput!) {
  createQuestionaireGroup(input: $input) @rest(type: "CreateQuestionaireGroup", path: "/groups", method: "POST", endpoint: "default") {
    id
    templateId
    groupName
    copyFromId
    ...
    `;
export function useCreateQuestionaireGroupMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateQuestionaireGroupMutation, CreateQuestionaireGroupMutationVariables>) {
        return ApolloReactHooks.useMutation<CreateQuestionaireGroupMutation, CreateQuestionaireGroupMutationVariables>(CreateQuestionaireGroupDocument, baseOptions);
      }
...
export type CreateQuestionaireGroupMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateQuestionaireGroupMutation, CreateQuestionaireGroupMutationVariables>;
export const UpdateQuestionaireGroupDocument = gql`
    mutation UpdateQuestionaireGroup($id: ID!, $input: UpdateGroupsInput!) {
  updateQuestionaireGroup(id: $id, input: $input) @rest(type: "UpdateQuestionaireGroup", path: "/groups/{args.id}", method: "PUT", endpoint: "default") {
    id
    templateId
    groupName
    copyFromId
    ...
    `;
export function useUpdateQuestionaireGroupMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateQuestionaireGroupMutation, UpdateQuestionaireGroupMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateQuestionaireGroupMutation, UpdateQuestionaireGroupMutationVariables>(UpdateQuestionaireGroupDocument, baseOptions);
      }
...
export type UpdateQuestionaireGroupMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateQuestionaireGroupMutation, UpdateQuestionaireGroupMutationVariables>;
export const DeleteQuestionaireGroupDocument = gql`
    mutation DeleteQuestionaireGroup($id: ID!) {
  deleteQuestionaireGroup(id: $id) @rest(type: "DeleteQuestionaireGroup", path: "/groups/{args.id}", method: "DELETE", endpoint: "default")
}
    `;
export function useDeleteQuestionaireGroupMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<DeleteQuestionaireGroupMutation, DeleteQuestionaireGroupMutationVariables>) {
        return ApolloReactHooks.useMutation<DeleteQuestionaireGroupMutation, DeleteQuestionaireGroupMutationVariables>(DeleteQuestionaireGroupDocument, baseOptions);
      }
...
export type DeleteQuestionaireGroupMutationOptions = ApolloReactCommon.BaseMutationOptions<DeleteQuestionaireGroupMutation, DeleteQuestionaireGroupMutationVariables>;
export const CreateQuestionDocument = gql`
    mutation CreateQuestion($input: QuestionInput!) {
  createQuestion(input: $input) @rest(type: "CreateQuestion", path: "/question", method: "POST", endpoint: "default") {
    id
    groupId
    order
    type
...
export const UpdateQuestionDocument = gql`
  ...
  updateQuestion(questionId: $questionId, input: $input) @rest(type: "UpdateQuestion", path: "/question/{args.questionId}", method: "PUT", endpoint: "default") {
    id
    groupId
    order
    type
...
export const TiaraSendMessageDocument = gql`
  ...
  tiaraSendMessage(input: $input)
    ...
    `;
export function useTiaraSendMessageMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<TiaraSendMessageMutation, TiaraSendMessageMutationVariables>) {
        return ApolloReactHooks.useMutation<TiaraSendMessageMutation, TiaraSendMessageMutationVariables>(TiaraSendMessageDocument, baseOptions);
      }
...
export type TiaraSendMessageMutationOptions = ApolloReactCommon.BaseMutationOptions<TiaraSendMessageMutation, TiaraSendMessageMutationVariables>;
export const UpdateWorkflowActionDocument = gql`
  ...
  updateWorkflowAction(id: $id, input: $input) {
    ...
    `;
export function useUpdateWorkflowActionMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateWorkflowActionMutation, UpdateWorkflowActionMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateWorkflowActionMutation, UpdateWorkflowActionMutationVariables>(UpdateWorkflowActionDocument, baseOptions);
      }
...
export type UpdateWorkflowActionMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateWorkflowActionMutation, UpdateWorkflowActionMutationVariables>;
export const UpdateWorkflowTriggerDocument = gql`
  ...
  updateWorkflowTrigger(id: $id, input: $input) {
    ...
    `;
export function useUpdateWorkflowTriggerMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateWorkflowTriggerMutation, UpdateWorkflowTriggerMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateWorkflowTriggerMutation, UpdateWorkflowTriggerMutationVariables>(UpdateWorkflowTriggerDocument, baseOptions);
      }
...
export type UpdateWorkflowTriggerMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateWorkflowTriggerMutation, UpdateWorkflowTriggerMutationVariables>;
export const GetAllocateDocument = gql`
    query GetAllocate($id: ID!) {
  getAllocate(id: $id) @rest(type: "GetAllocateResponse", path: "/get-allocate?id={args.id}", method: "GET", endpoint: "default") {
    id
    companyId
    objectId
    name
    ...
    `;
export function useGetAllocateQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetAllocateQuery, GetAllocateQueryVariables>) {
        return ApolloReactHooks.useQuery<GetAllocateQuery, GetAllocateQueryVariables>(GetAllocateDocument, baseOptions);
      }
export function useGetAllocateLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetAllocateQuery, GetAllocateQueryVariables>) {
...
export const ListAllocatesDocument = gql`
  ...
  listAllocates(objectId: $objectId) @rest(type: "ListAllocates", path: "/list-allocates?objectId={args.objectId}", method: "GET", endpoint: "default") {
    id
    companyId
    objectId
    name
    ...
    `;
export function useListAllocatesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListAllocatesQuery, ListAllocatesQueryVariables>) {
        return ApolloReactHooks.useQuery<ListAllocatesQuery, ListAllocatesQueryVariables>(ListAllocatesDocument, baseOptions);
      }
export function useListAllocatesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListAllocatesQuery, ListAllocatesQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListAllocatesQuery, ListAllocatesQueryVariables>(ListAllocatesDocument, baseOptions);
        }
...
export const GetBillingDocument = gql`
  ...
  getBilling {
    ...
    `;
export function useGetBillingQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBillingQuery, GetBillingQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBillingQuery, GetBillingQueryVariables>(GetBillingDocument, baseOptions);
      }
export function useGetBillingLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBillingQuery, GetBillingQueryVariables>) {
...
export const ListCalendarDocument = gql`
  ...
  listCalendar(input: $input) @rest(type: "ListCalendar", path: "/calendar-search", method: "POST", endpoint: "default") {
    id
    from
    to
    travelTimeBefore
    ...
    `;
export function useListCalendarQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListCalendarQuery, ListCalendarQueryVariables>) {
        return ApolloReactHooks.useQuery<ListCalendarQuery, ListCalendarQueryVariables>(ListCalendarDocument, baseOptions);
      }
export function useListCalendarLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListCalendarQuery, ListCalendarQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListCalendarQuery, ListCalendarQueryVariables>(ListCalendarDocument, baseOptions);
        }
...
export const GetAppointmentDocument = gql`
  ...
  getAppointment(appointmentId: $appointmentId) @rest(type: "GetAppointment", path: "/calendar-getappointment", method: "POST", endpoint: "default") {
    id
    from
    to
    travelTimeBefore
    ...
    `;
export function useGetAppointmentQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetAppointmentQuery, GetAppointmentQueryVariables>) {
        return ApolloReactHooks.useQuery<GetAppointmentQuery, GetAppointmentQueryVariables>(GetAppointmentDocument, baseOptions);
      }
export function useGetAppointmentLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetAppointmentQuery, GetAppointmentQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetAppointmentQuery, GetAppointmentQueryVariables>(GetAppointmentDocument, baseOptions);
        }
...
export type GetAppointmentQueryResult = ApolloReactCommon.QueryResult<GetAppointmentQuery, GetAppointmentQueryVariables>;
export const CheckCompanyRegisteredDocument = gql`
  ...
  checkCompanyRegistered(name: $name) {
    ...
    `;
export function useCheckCompanyRegisteredQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<CheckCompanyRegisteredQuery, CheckCompanyRegisteredQueryVariables>) {
        return ApolloReactHooks.useQuery<CheckCompanyRegisteredQuery, CheckCompanyRegisteredQueryVariables>(CheckCompanyRegisteredDocument, baseOptions);
      }
export function useCheckCompanyRegisteredLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CheckCompanyRegisteredQuery, CheckCompanyRegisteredQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<CheckCompanyRegisteredQuery, CheckCompanyRegisteredQueryVariables>(CheckCompanyRegisteredDocument, baseOptions);
        }
...
export type CheckCompanyRegisteredQueryResult = ApolloReactCommon.QueryResult<CheckCompanyRegisteredQuery, CheckCompanyRegisteredQueryVariables>;
...
export const GetCrmContactInformationDocument = gql`
  ...
  getCrmContactInformation(id: $id) {
    ...
    `;
export function useGetCrmContactInformationQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetCrmContactInformationQuery, GetCrmContactInformationQueryVariables>) {
        return ApolloReactHooks.useQuery<GetCrmContactInformationQuery, GetCrmContactInformationQueryVariables>(GetCrmContactInformationDocument, baseOptions);
      }
export function useGetCrmContactInformationLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetCrmContactInformationQuery, GetCrmContactInformationQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetCrmContactInformationQuery, GetCrmContactInformationQueryVariables>(GetCrmContactInformationDocument, baseOptions);
        }
...
export type GetCrmContactInformationQueryResult = ApolloReactCommon.QueryResult<GetCrmContactInformationQuery, GetCrmContactInformationQueryVariables>;
export const GetCrmFamilyContactsDocument = gql`
  ...
  getCrmFamilyContacts(id: $id) {
    ...
    `;
export function useGetCrmFamilyContactsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetCrmFamilyContactsQuery, GetCrmFamilyContactsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetCrmFamilyContactsQuery, GetCrmFamilyContactsQueryVariables>(GetCrmFamilyContactsDocument, baseOptions);
      }
export function useGetCrmFamilyContactsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetCrmFamilyContactsQuery, GetCrmFamilyContactsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetCrmFamilyContactsQuery, GetCrmFamilyContactsQueryVariables>(GetCrmFamilyContactsDocument, baseOptions);
        }
...
export type GetCrmFamilyContactsQueryResult = ApolloReactCommon.QueryResult<GetCrmFamilyContactsQuery, GetCrmFamilyContactsQueryVariables>;
export const GetCrmFinancialDocument = gql`
  ...
  getCrmFinancial(id: $id) {
    ...
    `;
export function useGetCrmFinancialQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetCrmFinancialQuery, GetCrmFinancialQueryVariables>) {
        return ApolloReactHooks.useQuery<GetCrmFinancialQuery, GetCrmFinancialQueryVariables>(GetCrmFinancialDocument, baseOptions);
      }
export function useGetCrmFinancialLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetCrmFinancialQuery, GetCrmFinancialQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetCrmFinancialQuery, GetCrmFinancialQueryVariables>(GetCrmFinancialDocument, baseOptions);
        }
...
export type GetCrmFinancialQueryResult = ApolloReactCommon.QueryResult<GetCrmFinancialQuery, GetCrmFinancialQueryVariables>;
export const GetCrmGeneralDocument = gql`
  ...
  getCrmGeneral(id: $id) {
    ...
    `;
export function useGetCrmGeneralQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetCrmGeneralQuery, GetCrmGeneralQueryVariables>) {
        return ApolloReactHooks.useQuery<GetCrmGeneralQuery, GetCrmGeneralQueryVariables>(GetCrmGeneralDocument, baseOptions);
      }
export function useGetCrmGeneralLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetCrmGeneralQuery, GetCrmGeneralQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetCrmGeneralQuery, GetCrmGeneralQueryVariables>(GetCrmGeneralDocument, baseOptions);
        }
...
export const GetCrmHomeSituationDocument = gql`
  ...
  getCrmHomeSituation(id: $id) {
    ...
    `;
export function useGetCrmHomeSituationQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetCrmHomeSituationQuery, GetCrmHomeSituationQueryVariables>) {
        return ApolloReactHooks.useQuery<GetCrmHomeSituationQuery, GetCrmHomeSituationQueryVariables>(GetCrmHomeSituationDocument, baseOptions);
      }
export function useGetCrmHomeSituationLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetCrmHomeSituationQuery, GetCrmHomeSituationQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetCrmHomeSituationQuery, GetCrmHomeSituationQueryVariables>(GetCrmHomeSituationDocument, baseOptions);
        }
...
export type GetCrmHomeSituationQueryResult = ApolloReactCommon.QueryResult<GetCrmHomeSituationQuery, GetCrmHomeSituationQueryVariables>;
export const CrmListDocument = gql`
    query crmList($type: CrmType, $status: CrmStatus, $sortColumn: String!, $sortDirection: SortDirection!, $from: Int!, $limit: Int, $city: String) {
  crmList(filters: {type: $type, status: $status, city: $city}, pagination: {from: $from, limit: $limit}, sort: {column: $sortColumn, direction: $sortDirection}) {
    items {
      id
      type
      firstName
...
export function useCrmListLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CrmListQuery, CrmListQueryVariables>) {
...
export const ListCrmsCountDocument = gql`
  ...
  inactive: crmList(filters: {type: $type, status: Inactive}) {
    ...
    `;
export function useListCrmsCountQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListCrmsCountQuery, ListCrmsCountQueryVariables>) {
        return ApolloReactHooks.useQuery<ListCrmsCountQuery, ListCrmsCountQueryVariables>(ListCrmsCountDocument, baseOptions);
      }
export function useListCrmsCountLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListCrmsCountQuery, ListCrmsCountQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListCrmsCountQuery, ListCrmsCountQueryVariables>(ListCrmsCountDocument, baseOptions);
        }
...
export const GetCrmWithSameInfoDocument = gql`
  ...
  getCrmWithSameInfo(input: $input) {
    ...
    `;
export function useGetCrmWithSameInfoQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetCrmWithSameInfoQuery, GetCrmWithSameInfoQueryVariables>) {
        return ApolloReactHooks.useQuery<GetCrmWithSameInfoQuery, GetCrmWithSameInfoQueryVariables>(GetCrmWithSameInfoDocument, baseOptions);
      }
export function useGetCrmWithSameInfoLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetCrmWithSameInfoQuery, GetCrmWithSameInfoQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetCrmWithSameInfoQuery, GetCrmWithSameInfoQueryVariables>(GetCrmWithSameInfoDocument, baseOptions);
        }
...
export type GetCrmWithSameInfoQueryResult = ApolloReactCommon.QueryResult<GetCrmWithSameInfoQuery, GetCrmWithSameInfoQueryVariables>;
export const CrmBulkDetailsDocument = gql`
  ...
  status: getBulkDetails(input: {ids: $ids, field: Status, entity: Crm}) {
    ...
    `;
export function useCrmBulkDetailsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<CrmBulkDetailsQuery, CrmBulkDetailsQueryVariables>) {
        return ApolloReactHooks.useQuery<CrmBulkDetailsQuery, CrmBulkDetailsQueryVariables>(CrmBulkDetailsDocument, baseOptions);
      }
export function useCrmBulkDetailsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CrmBulkDetailsQuery, CrmBulkDetailsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<CrmBulkDetailsQuery, CrmBulkDetailsQueryVariables>(CrmBulkDetailsDocument, baseOptions);
        }
...
export type CrmBulkDetailsQueryResult = ApolloReactCommon.QueryResult<CrmBulkDetailsQuery, CrmBulkDetailsQueryVariables>;
export const ListDmsFolderFilesDocument = gql`
    query ListDmsFolderFiles($folderId: ID!) {
  listDmsFolderFiles(folderId: $folderId) @rest(type: "ListDmsFolderFiles", path: "/dms/files/list/{args.folderId}", method: "GET", endpoint: "default") {
    id
    folderId
    companyId
    fileName
    ...
    `;
export function useListDmsFolderFilesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListDmsFolderFilesQuery, ListDmsFolderFilesQueryVariables>) {
        return ApolloReactHooks.useQuery<ListDmsFolderFilesQuery, ListDmsFolderFilesQueryVariables>(ListDmsFolderFilesDocument, baseOptions);
      }
export function useListDmsFolderFilesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListDmsFolderFilesQuery, ListDmsFolderFilesQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListDmsFolderFilesQuery, ListDmsFolderFilesQueryVariables>(ListDmsFolderFilesDocument, baseOptions);
        }
...
export type ListDmsFolderFilesQueryResult = ApolloReactCommon.QueryResult<ListDmsFolderFilesQuery, ListDmsFolderFilesQueryVariables>;
export const ListDmsFoldersDocument = gql`
    query ListDmsFolders($entityId: ID!, $withFileAmount: Boolean) {
  listDmsFolders(entityId: $entityId, withFileAmount: $withFileAmount) @rest(type: "ListDmsFolders", path: "/dms/folders/list/{args.entityId}?withFileAmount={args.withFileAmount}", method: "GET", endpoint: "default") {
    id
    entityId
    companyId
    foldername
    ...
    `;
export function useListDmsFoldersQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListDmsFoldersQuery, ListDmsFoldersQueryVariables>) {
        return ApolloReactHooks.useQuery<ListDmsFoldersQuery, ListDmsFoldersQueryVariables>(ListDmsFoldersDocument, baseOptions);
      }
export function useListDmsFoldersLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListDmsFoldersQuery, ListDmsFoldersQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListDmsFoldersQuery, ListDmsFoldersQueryVariables>(ListDmsFoldersDocument, baseOptions);
        }
...
export type ListDmsFoldersQueryResult = ApolloReactCommon.QueryResult<ListDmsFoldersQuery, ListDmsFoldersQueryVariables>;
export const ListEmailFoldersDocument = gql`
    query ListEmailFolders($accountId: String!) {
  listEmailFolders(accountId: $accountId) @rest(type: "ListEmailFolders", path: "/nylas-email-folders-unread-count?accountId={args.accountId}", method: "GET", endpoint: "default") {
    folder {
      id
      name
      displayName
    ...
    `;
export function useListEmailFoldersQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListEmailFoldersQuery, ListEmailFoldersQueryVariables>) {
        return ApolloReactHooks.useQuery<ListEmailFoldersQuery, ListEmailFoldersQueryVariables>(ListEmailFoldersDocument, baseOptions);
      }
export function useListEmailFoldersLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListEmailFoldersQuery, ListEmailFoldersQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListEmailFoldersQuery, ListEmailFoldersQueryVariables>(ListEmailFoldersDocument, baseOptions);
        }
...
export type ListEmailFoldersQueryResult = ApolloReactCommon.QueryResult<ListEmailFoldersQuery, ListEmailFoldersQueryVariables>;
export const ListEmailDocument = gql`
    query ListEmail($accountId: String!, $folderId: ID, $unread: Boolean) {
  listEmail(accountId: $accountId, folderId: $folderId, unread: $unread) @rest(type: "ListEmail", path: "/nylas-email-list?accountId={args.accountId}&folderId={args.folderId}&unread={args.unread}", method: "GET", endpoint: "default") {
    id
    folder {
      id
      name
    ...
    `;
export function useListEmailQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListEmailQuery, ListEmailQueryVariables>) {
        return ApolloReactHooks.useQuery<ListEmailQuery, ListEmailQueryVariables>(ListEmailDocument, baseOptions);
      }
export function useListEmailLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListEmailQuery, ListEmailQueryVariables>) {
...
export const GetEmailDocument = gql`
  ...
  getEmail(accountId: $accountId, emailId: $emailId) @rest(type: "GetEmail", path: "/nylas-email-item?accountId={args.accountId}&emailId={args.emailId}", method: "GET", endpoint: "default") {
    id
    folder {
      id
      name
    ...
    `;
export function useGetEmailQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetEmailQuery, GetEmailQueryVariables>) {
        return ApolloReactHooks.useQuery<GetEmailQuery, GetEmailQueryVariables>(GetEmailDocument, baseOptions);
      }
export function useGetEmailLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetEmailQuery, GetEmailQueryVariables>) {
...
export const GetKikSettingsDocument = gql`
  ...
  getKikSettings {
    ...
    `;
export function useGetKikSettingsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetKikSettingsQuery, GetKikSettingsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetKikSettingsQuery, GetKikSettingsQueryVariables>(GetKikSettingsDocument, baseOptions);
      }
export function useGetKikSettingsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetKikSettingsQuery, GetKikSettingsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetKikSettingsQuery, GetKikSettingsQueryVariables>(GetKikSettingsDocument, baseOptions);
        }
...
export type GetKikSettingsQueryResult = ApolloReactCommon.QueryResult<GetKikSettingsQuery, GetKikSettingsQueryVariables>;
...
export const GetCrmLabelsDocument = gql`
  ...
  getCrmLabels(parentId: $id, properties: $properties) {
    ...
    `;
export function useGetCrmLabelsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetCrmLabelsQuery, GetCrmLabelsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetCrmLabelsQuery, GetCrmLabelsQueryVariables>(GetCrmLabelsDocument, baseOptions);
      }
export function useGetCrmLabelsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetCrmLabelsQuery, GetCrmLabelsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetCrmLabelsQuery, GetCrmLabelsQueryVariables>(GetCrmLabelsDocument, baseOptions);
        }
...
export const GetMatchProfileDocument = gql`
  ...
  getMatchProfile(id: $id) @rest(type: "GetMatchProfileResponse", path: "/get-match?id={args.id}", method: "GET", endpoint: "default") {
    id
    crmId
    companyId
    propertyType
    ...
    `;
export function useGetMatchProfileQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetMatchProfileQuery, GetMatchProfileQueryVariables>) {
        return ApolloReactHooks.useQuery<GetMatchProfileQuery, GetMatchProfileQueryVariables>(GetMatchProfileDocument, baseOptions);
      }
export function useGetMatchProfileLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetMatchProfileQuery, GetMatchProfileQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetMatchProfileQuery, GetMatchProfileQueryVariables>(GetMatchProfileDocument, baseOptions);
        }
...
export type GetMatchProfileQueryResult = ApolloReactCommon.QueryResult<GetMatchProfileQuery, GetMatchProfileQueryVariables>;
export const ListMatchProfilesDocument = gql`
    query ListMatchProfiles($crmId: ID!) {
  listMatchProfiles(crmId: $crmId) @rest(type: "ListMatchProfileResponse", path: "/list-matches?crmId={args.crmId}", method: "GET", endpoint: "default") {
    id
    crmId
    companyId
    propertyType
    ...
    `;
export function useListMatchProfilesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListMatchProfilesQuery, ListMatchProfilesQueryVariables>) {
        return ApolloReactHooks.useQuery<ListMatchProfilesQuery, ListMatchProfilesQueryVariables>(ListMatchProfilesDocument, baseOptions);
      }
export function useListMatchProfilesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListMatchProfilesQuery, ListMatchProfilesQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListMatchProfilesQuery, ListMatchProfilesQueryVariables>(ListMatchProfilesDocument, baseOptions);
        }
...
export type ListMatchProfilesQueryResult = ApolloReactCommon.QueryResult<ListMatchProfilesQuery, ListMatchProfilesQueryVariables>;
...
export const ListNcpsDocument = gql`
    query ListNcps($pricingType: PricingType, $projectType: ProjectType, $archived: Boolean!, $sortColumn: String!, $sortDirection: SortDirection!, $from: Int!, $limit: Int) {
  listNcps(filters: {archived: $archived, pricingType: $pricingType, projectType: $projectType}, pagination: {from: $from, limit: $limit}, sort: {column: $sortColumn, direction: $sortDirection}) {
    items {
      id
      dateCreated
      dateUpdated
...
export const NcpOverallInfoDocument = gql`
    query NcpOverallInfo($id: ID!, $archived: Boolean, $picturesSort: Sort, $sortColumn: String!, $sortDirection: SortDirection!, $from: Int, $limit: Int, $name: String) {
  getNcp(id: $id) {
    startSale
    startDelivery
    properties
  ...
  listObjectTypes(filters: {ncpId: $id, archived: $archived}, pagination: {from: $from, limit: $limit}, sort: {column: $sortColumn, direction: $sortDirection}) {
    items {
      id
      ncpId
      dateCreated
  ...
  getProjectPhases(filters: {name: $name, ncpId: $id}, pagination: {from: $from, limit: $limit}) {
    ...
    `;
export function useNcpOverallInfoQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<NcpOverallInfoQuery, NcpOverallInfoQueryVariables>) {
        return ApolloReactHooks.useQuery<NcpOverallInfoQuery, NcpOverallInfoQueryVariables>(NcpOverallInfoDocument, baseOptions);
      }
export function useNcpOverallInfoLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<NcpOverallInfoQuery, NcpOverallInfoQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<NcpOverallInfoQuery, NcpOverallInfoQueryVariables>(NcpOverallInfoDocument, baseOptions);
        }
...
export type NcpOverallInfoQueryResult = ApolloReactCommon.QueryResult<NcpOverallInfoQuery, NcpOverallInfoQueryVariables>;
...
export const ListNylasAccountDocument = gql`
  ...
  listNylasAccount(isCalendarConnected: $isCalendarConnected, isEmailConnected: $isEmailConnected) @rest(type: "NylasAccount", path: "/nylas-account-list", method: "GET", endpoint: "default") {
    id
    email
    provider
    billingState
    ...
    `;
export function useListNylasAccountQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListNylasAccountQuery, ListNylasAccountQueryVariables>) {
        return ApolloReactHooks.useQuery<ListNylasAccountQuery, ListNylasAccountQueryVariables>(ListNylasAccountDocument, baseOptions);
      }
export function useListNylasAccountLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListNylasAccountQuery, ListNylasAccountQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListNylasAccountQuery, ListNylasAccountQueryVariables>(ListNylasAccountDocument, baseOptions);
        }
...
export type ListNylasAccountQueryResult = ApolloReactCommon.QueryResult<ListNylasAccountQuery, ListNylasAccountQueryVariables>;
export const GetNylasAuthUrlDocument = gql`
    query GetNylasAuthUrl($input: NylasAccountAuthOptions!) {
  getNylasAuthUrl(input: $input)
}
    `;
export function useGetNylasAuthUrlQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetNylasAuthUrlQuery, GetNylasAuthUrlQueryVariables>) {
        return ApolloReactHooks.useQuery<GetNylasAuthUrlQuery, GetNylasAuthUrlQueryVariables>(GetNylasAuthUrlDocument, baseOptions);
      }
export function useGetNylasAuthUrlLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetNylasAuthUrlQuery, GetNylasAuthUrlQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetNylasAuthUrlQuery, GetNylasAuthUrlQueryVariables>(GetNylasAuthUrlDocument, baseOptions);
        }
...
export type GetNylasAuthUrlQueryResult = ApolloReactCommon.QueryResult<GetNylasAuthUrlQuery, GetNylasAuthUrlQueryVariables>;
...
export const MovePimDataDocument = gql`
  ...
  relet: listNcps(filters: {archived: false, projectType: Relet}) {
    ...
    `;
export function useMovePimDataQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<MovePimDataQuery, MovePimDataQueryVariables>) {
        return ApolloReactHooks.useQuery<MovePimDataQuery, MovePimDataQueryVariables>(MovePimDataDocument, baseOptions);
      }
export function useMovePimDataLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<MovePimDataQuery, MovePimDataQueryVariables>) {
...
export function usePimInfoLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<PimInfoQuery, PimInfoQueryVariables>) {
...
export function useGetUsersCountLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetUsersCountQuery, GetUsersCountQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetUsersCountQuery, GetUsersCountQueryVariables>(GetUsersCountDocument, baseOptions);
        }
...
export const GetMyTeamMembersDocument = gql`
  ...
  members: getMyTeamMembers(search: $search, pagination: {from: $from, limit: $limit}) {
    ...
    `;
export function useGetMyTeamMembersQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetMyTeamMembersQuery, GetMyTeamMembersQueryVariables>) {
        return ApolloReactHooks.useQuery<GetMyTeamMembersQuery, GetMyTeamMembersQueryVariables>(GetMyTeamMembersDocument, baseOptions);
      }
export function useGetMyTeamMembersLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetMyTeamMembersQuery, GetMyTeamMembersQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetMyTeamMembersQuery, GetMyTeamMembersQueryVariables>(GetMyTeamMembersDocument, baseOptions);
        }
...
export type GetMyTeamMembersQueryResult = ApolloReactCommon.QueryResult<GetMyTeamMembersQuery, GetMyTeamMembersQueryVariables>;
...
export const GetSalesListDocument = gql`
  ...
  getSalesList(label: $label, status: $status, sort: {column: $sortColumn, direction: $sortDirection}) @rest(type: "ListSales", path: "/get-sales-list?label={args.label}&status={args.status}", method: "GET", endpoint: "default") {
    items {
      id
      label
      status
    ...
    `;
export function useGetSalesListQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetSalesListQuery, GetSalesListQueryVariables>) {
        return ApolloReactHooks.useQuery<GetSalesListQuery, GetSalesListQueryVariables>(GetSalesListDocument, baseOptions);
      }
export function useGetSalesListLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetSalesListQuery, GetSalesListQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetSalesListQuery, GetSalesListQueryVariables>(GetSalesListDocument, baseOptions);
        }
...
export const SettingInfoDocument = gql`
  ...
  getTeams {
    ...
    `;
export function useSettingInfoQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<SettingInfoQuery, SettingInfoQueryVariables>) {
        return ApolloReactHooks.useQuery<SettingInfoQuery, SettingInfoQueryVariables>(SettingInfoDocument, baseOptions);
      }
export function useSettingInfoLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SettingInfoQuery, SettingInfoQueryVariables>) {
...
export const GetTaskLabelsDocument = gql`
  ...
  getTaskLabels(parentId: $id, properties: $properties) {
    ...
    `;
export function useGetTaskLabelsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTaskLabelsQuery, GetTaskLabelsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTaskLabelsQuery, GetTaskLabelsQueryVariables>(GetTaskLabelsDocument, baseOptions);
      }
export function useGetTaskLabelsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTaskLabelsQuery, GetTaskLabelsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTaskLabelsQuery, GetTaskLabelsQueryVariables>(GetTaskLabelsDocument, baseOptions);
        }
...
export const GetTasksFullSummaryDocument = gql`
  ...
  getTasksFullSummary(filters: {assignees: $assignees}) {
    ...
    `;
export function useGetTasksFullSummaryQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTasksFullSummaryQuery, GetTasksFullSummaryQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTasksFullSummaryQuery, GetTasksFullSummaryQueryVariables>(GetTasksFullSummaryDocument, baseOptions);
      }
export function useGetTasksFullSummaryLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTasksFullSummaryQuery, GetTasksFullSummaryQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTasksFullSummaryQuery, GetTasksFullSummaryQueryVariables>(GetTasksFullSummaryDocument, baseOptions);
        }
...
export const GetTasksSummaryByStatusDocument = gql`
  ...
  getTasksSummaryByStatus(filters: {search: $search, assignees: $assignees, deadlines: $deadlines}) {
    ...
    `;
export function useGetTasksSummaryByStatusQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTasksSummaryByStatusQuery, GetTasksSummaryByStatusQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTasksSummaryByStatusQuery, GetTasksSummaryByStatusQueryVariables>(GetTasksSummaryByStatusDocument, baseOptions);
      }
export function useGetTasksSummaryByStatusLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTasksSummaryByStatusQuery, GetTasksSummaryByStatusQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTasksSummaryByStatusQuery, GetTasksSummaryByStatusQueryVariables>(GetTasksSummaryByStatusDocument, baseOptions);
        }
...
export type GetTasksSummaryByStatusQueryResult = ApolloReactCommon.QueryResult<GetTasksSummaryByStatusQuery, GetTasksSummaryByStatusQueryVariables>;
...
export const GetTeamDetailsDocument = gql`
  ...
  getTeamDetails(id: $id) {
    ...
    `;
export function useGetTeamDetailsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTeamDetailsQuery, GetTeamDetailsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTeamDetailsQuery, GetTeamDetailsQueryVariables>(GetTeamDetailsDocument, baseOptions);
      }
export function useGetTeamDetailsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTeamDetailsQuery, GetTeamDetailsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTeamDetailsQuery, GetTeamDetailsQueryVariables>(GetTeamDetailsDocument, baseOptions);
        }
...
export type GetTeamDetailsQueryResult = ApolloReactCommon.QueryResult<GetTeamDetailsQuery, GetTeamDetailsQueryVariables>;
export const GetQuestionaireDocument = gql`
    query GetQuestionaire($id: ID!, $type: String) {
  getQuestionaire(id: $id, type: $type) @rest(type: "Questionaire", path: "/template/{args.type}/{args.id}", method: "GET", endpoint: "default") {
    id
    templateName
    isAdmin
    published
    ...
    `;
export function useGetQuestionaireQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetQuestionaireQuery, GetQuestionaireQueryVariables>) {
        return ApolloReactHooks.useQuery<GetQuestionaireQuery, GetQuestionaireQueryVariables>(GetQuestionaireDocument, baseOptions);
      }
export function useGetQuestionaireLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetQuestionaireQuery, GetQuestionaireQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetQuestionaireQuery, GetQuestionaireQueryVariables>(GetQuestionaireDocument, baseOptions);
        }
...
export type GetQuestionaireQueryResult = ApolloReactCommon.QueryResult<GetQuestionaireQuery, GetQuestionaireQueryVariables>;
export const ListQuestionaireGroupsDocument = gql`
    query ListQuestionaireGroups($templateId: ID!) {
  listQuestionaireGroups(templateId: $templateId) @rest(type: "ListQuestionaireGroups", path: "/groups/{args.templateId}", method: "GET", endpoint: "default") {
    id
    templateId
    groupName
    copyFromId
    ...
    `;
export function useListQuestionaireGroupsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListQuestionaireGroupsQuery, ListQuestionaireGroupsQueryVariables>) {
        return ApolloReactHooks.useQuery<ListQuestionaireGroupsQuery, ListQuestionaireGroupsQueryVariables>(ListQuestionaireGroupsDocument, baseOptions);
      }
export function useListQuestionaireGroupsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListQuestionaireGroupsQuery, ListQuestionaireGroupsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListQuestionaireGroupsQuery, ListQuestionaireGroupsQueryVariables>(ListQuestionaireGroupsDocument, baseOptions);
        }
...
export type ListQuestionaireGroupsQueryResult = ApolloReactCommon.QueryResult<ListQuestionaireGroupsQuery, ListQuestionaireGroupsQueryVariables>;
export const GetQuestionairesDocument = gql`
  ...
  getQuestionaires(filters: $filters, pagination: $pagination, search: $search) @rest(type: "GetQuestionaires", path: "/templates/{args.filters.type}?templateStatus={args.filters.templateStatus}&page={args.pagination.page}&limit={args.pagination.limit}", method: "GET", endpoint: "default") {
    items {
      id
      templateName
      isAdmin
    ...
    `;
export function useGetQuestionairesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetQuestionairesQuery, GetQuestionairesQueryVariables>) {
        return ApolloReactHooks.useQuery<GetQuestionairesQuery, GetQuestionairesQueryVariables>(GetQuestionairesDocument, baseOptions);
      }
export function useGetQuestionairesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetQuestionairesQuery, GetQuestionairesQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetQuestionairesQuery, GetQuestionairesQueryVariables>(GetQuestionairesDocument, baseOptions);
        }
...
export type GetQuestionairesQueryResult = ApolloReactCommon.QueryResult<GetQuestionairesQuery, GetQuestionairesQueryVariables>;
export const GetQuestionaireGroupDocument = gql`
    query GetQuestionaireGroup($id: ID!) {
  getQuestionaireGroup(id: $id) @rest(type: "GetQuestionaireGroup", path: "/groups/{args.id}", method: "GET", endpoint: "default") {
    id
    templateId
    groupName
    copyFromId
    ...
    `;
export function useGetQuestionaireGroupQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetQuestionaireGroupQuery, GetQuestionaireGroupQueryVariables>) {
        return ApolloReactHooks.useQuery<GetQuestionaireGroupQuery, GetQuestionaireGroupQueryVariables>(GetQuestionaireGroupDocument, baseOptions);
      }
export function useGetQuestionaireGroupLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetQuestionaireGroupQuery, GetQuestionaireGroupQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetQuestionaireGroupQuery, GetQuestionaireGroupQueryVariables>(GetQuestionaireGroupDocument, baseOptions);
        }
...
export type GetQuestionaireGroupQueryResult = ApolloReactCommon.QueryResult<GetQuestionaireGroupQuery, GetQuestionaireGroupQueryVariables>;
export const ListQuestionsDocument = gql`
    query ListQuestions($groupId: ID!) {
  listQuestions(groupId: $groupId) @rest(type: "ListQuestions", path: "/question?groupId={args.groupId}", method: "GET", endpoint: "default") {
    id
    groupId
    order
    type
    ...
    `;
export function useListQuestionsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListQuestionsQuery, ListQuestionsQueryVariables>) {
        return ApolloReactHooks.useQuery<ListQuestionsQuery, ListQuestionsQueryVariables>(ListQuestionsDocument, baseOptions);
      }
export function useListQuestionsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListQuestionsQuery, ListQuestionsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ListQuestionsQuery, ListQuestionsQueryVariables>(ListQuestionsDocument, baseOptions);
        }
...
export const GetQuestionairesCountDocument = gql`
  ...
  active: getQuestionaires(filters: $filters, search: $search) @rest(type: "GetQuestionairesCount", path: "/templates/{args.filters.type}?templateStatus=Active&countOnly=true", method: "GET", endpoint: "default") {
    count
  }
  inactive: getQuestionaires(filters: $filters, search: $search) @rest(type: "GetQuestionairesCount", path: "/templates/{args.filters.type}?templateStatus=InActive&countOnly=true", method: "GET", endpoint: "default") {
    count
  }
}
    `;
export function useGetQuestionairesCountQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetQuestionairesCountQuery, GetQuestionairesCountQueryVariables>) {
        return ApolloReactHooks.useQuery<GetQuestionairesCountQuery, GetQuestionairesCountQueryVariables>(GetQuestionairesCountDocument, baseOptions);
      }
export function useGetQuestionairesCountLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetQuestionairesCountQuery, GetQuestionairesCountQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetQuestionairesCountQuery, GetQuestionairesCountQueryVariables>(GetQuestionairesCountDocument, baseOptions);
        }
...
export type GetQuestionairesCountQueryResult = ApolloReactCommon.QueryResult<GetQuestionairesCountQuery, GetQuestionairesCountQueryVariables>;
export const GetTiaraMutationsDocument = gql`
  ...
  getTiaraMutations(entityId: $entityId, entity: $entity) {
    ...
    `;
export function useGetTiaraMutationsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTiaraMutationsQuery, GetTiaraMutationsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTiaraMutationsQuery, GetTiaraMutationsQueryVariables>(GetTiaraMutationsDocument, baseOptions);
      }
export function useGetTiaraMutationsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTiaraMutationsQuery, GetTiaraMutationsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTiaraMutationsQuery, GetTiaraMutationsQueryVariables>(GetTiaraMutationsDocument, baseOptions);
        }
...
export type GetTiaraMutationsQueryResult = ApolloReactCommon.QueryResult<GetTiaraMutationsQuery, GetTiaraMutationsQueryVariables>;
export const GetTiaraValidationDocument = gql`
  ...
  getTiaraValidation(entityId: $entityId, entity: $entity) {
    ...
    `;
export function useGetTiaraValidationQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTiaraValidationQuery, GetTiaraValidationQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTiaraValidationQuery, GetTiaraValidationQueryVariables>(GetTiaraValidationDocument, baseOptions);
      }
export function useGetTiaraValidationLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTiaraValidationQuery, GetTiaraValidationQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTiaraValidationQuery, GetTiaraValidationQueryVariables>(GetTiaraValidationDocument, baseOptions);
        }
...
export type GetTiaraValidationQueryResult = ApolloReactCommon.QueryResult<GetTiaraValidationQuery, GetTiaraValidationQueryVariables>;